...
FUN_0066ef60(_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *param_1,
...

{
  ...
  FUN_0066c160(p_Var2);
  local_8 = 0;
  uVar3 = FUN_00672df0(param_2,param_3,param_4,local_14,uVar1);
  local_8 = 0xffffffff;
  FUN_0066b5b0();
  ExceptionList = local_10;
  return uVar3;
