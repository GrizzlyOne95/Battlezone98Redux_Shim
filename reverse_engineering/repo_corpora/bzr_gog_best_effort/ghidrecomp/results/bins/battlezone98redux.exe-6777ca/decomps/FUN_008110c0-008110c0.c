...
void FUN_008110c0(undefined4 param_1,undefined4 param_2)

{
  ...
  local_14 = uVar1;
  basic_string<>(&DAT_008980b8);
  local_8 = 1;
  uVar2 = FUN_00809a00(local_60,param_2);
  local_8._0_1_ = 2;
  uVar3 = FUN_008098c0(local_94,param_2);
  local_8._0_1_ = 3;
