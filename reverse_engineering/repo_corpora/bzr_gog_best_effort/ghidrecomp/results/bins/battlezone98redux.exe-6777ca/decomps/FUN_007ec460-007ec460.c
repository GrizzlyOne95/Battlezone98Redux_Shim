...
undefined1
FUN_007ec460(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
            undefined4 param_5)

{
  ...
  cVar1 = FUN_007eccc0(uVar2,puVar3);
  if (cVar1 == '\0') {
    puVar3 = (undefined1 *)FUN_0066f210();
    uVar2 = FUN_007ecc00(local_10,param_2,param_3,param_4,param_5,*puVar3);
    uVar2 = FUN_007ecd10(local_14,param_1,uVar2);
    cVar1 = FUN_007ecd30(uVar2);
    if (cVar1 == '\0') {
      return 0;
    }
  }
