...
void FUN_0074ef30(undefined4 param_1,int param_2)

{
  ...
  pbVar2 = (basic_ostream<char,struct_std::char_traits<char>_> *)
           FUN_004bc590(local_14,"CGalaxyLobby::OnLobbyDataRetrieveFailure, failure: ",param_2,
                        FUN_004bc8c0,uVar1);
  pbVar2 = std::basic_ostream<char,struct_std::char_traits<char>_>::operator<<(pbVar2,param_2);
