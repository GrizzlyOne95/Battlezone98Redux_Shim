...
void FUN_0079cf70(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (local_20 != 0) {
    ...
    rotate<>(param_1,local_1c[1],local_20 * 0x18 + local_1c[1]);
    local_1c[1] = local_20 * 0x18 + local_1c[1];
