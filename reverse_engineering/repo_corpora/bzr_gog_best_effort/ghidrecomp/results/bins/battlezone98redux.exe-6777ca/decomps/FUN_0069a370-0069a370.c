...
undefined4
FUN_0069a370(undefined4 param_1,int param_2,undefined4 param_3,undefined4 param_4,int param_5,
            undefined4 param_6)
...
LAB_0069a3cf:
    ...
    if (local_6 != local_10[1]) goto LAB_0069a3cf;
    local_c = local_c + 2;
    local_10 = local_10 + 2;
  } while (local_6 != 0);
  local_18 = 0;
LAB_0069a3d7:
  local_20 = local_18;
  if (local_18 == 0) {
    local_14 = FUN_006994c0(1,param_5);
