...
int FUN_006cc5c0(undefined4 param_1)

{
  ...
  if (cVar1 == '\0') {
    ...
    cVar1 = FUN_00579110(uVar2,uVar3);
    if (cVar1 == '\0') goto LAB_006cc65f;
  }
  local_14 = local_10[0];
  uVar2 = std::allocator<char>::allocator<char>(&local_6);
  uVar3 = FUN_00427550(local_1c,param_1,uVar2);
  puVar4 = (undefined4 *)FUN_006dce30(local_20,local_14,&DAT_0260b08b,uVar3,uVar2);
  local_10[0] = *puVar4;
LAB_006cc65f:
  iVar5 = FUN_00422150();
  return iVar5 + 0x10;
