...
void FUN_00502a80(undefined4 param_1)
  ...
  if (local_1c == 0) {
    ...
    if (local_20 == 0) {
      ...
      if (iVar2 == 0) {
        ...
        local_18 = FUN_005c9ec0(local_2c);
      }
      else {
        local_28 = FUN_0082d377(param_1,1,0);
        local_24 = FUN_0082c1fd(param_1,2,0);
        local_18 = FUN_005c9f10(local_28,local_24);
      }
    }
    else {
      local_18 = FUN_005c9dc0(local_20,0);
    }
  }
  else {
    ...
    local_10 = puVar1[1];
    local_c = puVar1[2];
    local_18 = FUN_005c9dc0(&local_14,0);
  }
