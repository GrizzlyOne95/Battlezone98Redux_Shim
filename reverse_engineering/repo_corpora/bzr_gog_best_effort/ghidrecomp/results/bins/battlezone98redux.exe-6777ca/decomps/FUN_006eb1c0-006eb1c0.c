...
facet * FUN_006eb1c0(locale *param_1)

{
  ...
  local_8 = 0;
  local_14 = (facet *)DAT_02cc2c70;
  local_20 = std::locale::id::operator_unsigned_int((id *)&DAT_02cc3798);
  local_18 = (facet *)FUN_00417ba0(local_20);
  if (local_18 == (facet *)0x0) {
    if (local_14 == (facet *)0x0) {
      uVar2 = std::locale::facet::_Getcat(&local_14,param_1);
      if (uVar2 == 0xffffffff) {
