...
bool FUN_0080b800(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  ...
  cVar1 = FUN_0080c000(local_c,*puVar3,puVar3[1],puVar3[2],puVar3[3],puVar3[4]);
  if (cVar1 == '\0') {
    *param_1 = local_8;
  }
  return cVar1 == '\0';
