...
void __fastcall FUN_005fbce0(int param_1)

{
  ...
  local_8 = 0xffffffff;
  puStack_c = &LAB_0084d17c;
  local_10 = ExceptionList;
  ExceptionList = &local_10;
  FUN_00462590(DAT_008e7000 ^ (uint)&stack0xfffffffc);
  local_18 = FUN_005e0f70(3);
  iVar3 = *(int *)(*(int *)(param_1 + 0x34) + 0xc4);
  if ((iVar3 < 0) || ((iVar3 < 1 && (*(int *)(*(int *)(param_1 + 0x34) + 0xc0) == 0)))) {
    if ((local_18 != 0) &&
