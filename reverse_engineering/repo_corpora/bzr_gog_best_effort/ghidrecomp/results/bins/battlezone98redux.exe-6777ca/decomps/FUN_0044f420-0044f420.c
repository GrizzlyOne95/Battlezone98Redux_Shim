...
FUN_0044f420(int *param_1,undefined4 param_2,int param_3,uint param_4,undefined4 *param_5)

{
  ...
  if (param_4 != 0) {
    ...
    if (uVar2 < param_4) {
      ...
      local_30 = uVar5;
      Getal(&local_15);
      local_20 = FUN_0044fa00(uVar5);
      local_28 = param_3 - *local_1c >> 2;
      local_24 = 0;
      local_8 = 0;
      uVar5 = FUN_00417780(param_5);
      FUN_0044f9c0(local_20 + local_28 * 4,param_4,uVar5);
      local_24 = local_24 + 1;
    ...
    if ((uint)(local_1c[1] - param_3 >> 2) < param_4) {
      ...
      FUN_0044f9c0(local_1c[1],param_4 - (local_1c[1] - param_3 >> 2),uVar5);
      uVar5 = FUN_0044f6f8();
      return uVar5;
    }
    local_38 = *param_5;
    ...
    FUN_0044fc00(param_3,param_3 + param_4 * 4,&local_38);
