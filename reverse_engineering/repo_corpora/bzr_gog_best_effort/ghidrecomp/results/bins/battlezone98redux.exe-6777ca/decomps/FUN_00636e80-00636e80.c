...
undefined1 __thiscall FUN_00636e80(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar4 = 0xc;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 0x68,0x30), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0x37;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x9c,0xdc), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x17c,0x18,6,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
    ...
    for (local_10 = 0; local_10 < 6; local_10 = local_10 + 1) {
      *(undefined4 *)(param_1 + 0x17c + local_10 * 4) = 0;
    }
    FUN_00637420();
