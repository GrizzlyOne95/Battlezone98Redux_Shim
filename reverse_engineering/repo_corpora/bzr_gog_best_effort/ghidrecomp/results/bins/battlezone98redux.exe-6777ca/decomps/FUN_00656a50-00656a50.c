...
undefined1 __thiscall FUN_00656a50(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar4 = 9;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 100,0x24), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0x20;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x8c,0x80), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x110,0x1c,7,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
    ...
    for (local_10 = 0; local_10 < 7; local_10 = local_10 + 1) {
      *(undefined4 *)(param_1 + 0x110 + local_10 * 4) = 0;
    }
    FUN_00656ff0();
