...
void FUN_006b19a0(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if (param_5 == '\0') {
    ...
    if (cVar1 == '\0') {
      ...
      local_10 = 0;
      iVar2 = WSASend(*param_1,param_2,param_3,&local_10,param_4,param_6,0);
