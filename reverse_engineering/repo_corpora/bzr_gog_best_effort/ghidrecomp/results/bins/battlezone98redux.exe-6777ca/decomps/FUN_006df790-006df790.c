...
undefined4 * __thiscall FUN_006df790(undefined4 *param_1,int param_2,int param_3)

{
  ...
  FUN_006df880(param_2);
  *param_1 = boost::exception_detail::
             clone_impl<struct_boost::exception_detail::error_info_injector<struct_boost::gregorian::bad_day_of_month>_>
             ::vftable;
