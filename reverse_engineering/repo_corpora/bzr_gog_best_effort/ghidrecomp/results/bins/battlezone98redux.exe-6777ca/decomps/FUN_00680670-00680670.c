...
void FUN_00680670(int param_1,undefined4 param_2,undefined4 param_3,int param_4,undefined4 param_5,
                 float param_6)

{
  ...
  *(undefined4 *)(param_1 + 0xbc) = param_5;
  this = *(Entity **)(param_1 + 0x94);
