...
void __fastcall FUN_005b38e0(int param_1)

{
  ...
  local_68 = param_1;
  local_80 = (**(code **)(*(int *)(*(int *)(param_1 + 0x20) + 0x18) + 0x30))();
  local_6c = (float *)(*(int *)(*(int *)(local_68 + 0x20) + 0x230) + 0xc4);
  sprintf(local_58," RecyclerProcess:");
  FUN_004b70f0();
  FUN_00462450();
  ...
  local_8c = 0x18;
  pfVar1 = (float *)(**(code **)(*(int *)(*(int *)(local_68 + 0x20) + 0x18) + 0xc))();
  local_64 = *pfVar1;
  local_60 = pfVar1[1];
  local_5c = pfVar1[2];
  ...
  if (*(int *)(local_68 + 0x2c) != 0) {
    (**(code **)(**(int **)(local_68 + 0x2c) + 0x20))();
  }
  FUN_0083e885();
  return;
}
