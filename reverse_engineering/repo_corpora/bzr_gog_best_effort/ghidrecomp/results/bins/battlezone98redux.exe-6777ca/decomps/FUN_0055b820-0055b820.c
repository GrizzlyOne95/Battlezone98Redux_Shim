...
undefined1 __thiscall FUN_0055b820(int param_1,undefined4 param_2)

{
  ...
  if (DAT_009173b7 == '\0') {
    ...
    uVar3 = 0x24;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x90,0x90), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x124,0x10,4,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
