...
undefined4
FUN_0070a860(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
            undefined4 param_5)

{
  ...
  undefined4 uVar4;
  undefined4 uVar5;
  _ExceptionHolder *p_Var6;
  _Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *p_Var7;
  ...
  if (local_14 == (void *)0x0) {
    ...
    local_18 = (_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *)
               FUN_00716470(uVar5,uVar4,uVar3,uVar2);
  }
  local_24 = local_18;
  local_8 = 0xffffffff;
  local_1c = local_18;
  ...
  local_8 = 1;
  p_Var7 = local_1c;
  p_Var6 = std::_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder>::_Getptr(local_1c);
  _Resetp0<>(p_Var6,p_Var7);
  shared_ptr<>(local_2c);
  local_20 = local_20 | 1;
  local_8 = 0xffffffff;
  FUN_006ca8c0();
