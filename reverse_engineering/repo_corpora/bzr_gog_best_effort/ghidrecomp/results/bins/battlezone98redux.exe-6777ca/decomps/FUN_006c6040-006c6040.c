...
void FUN_006c6040(undefined4 param_1,undefined4 param_2)

{
  ...
  if (cVar1 != '\0') {
    ...
    local_8._0_1_ = 2;
    uVar2 = basic_string<>("DeleteLobbyData");
    local_8._0_1_ = 3;
    local_bc = uVar2;
    local_b4 = uVar2;
    ...
    if (&stack0x00000000 == (undefined1 *)0x1a8) {
      ...
      local_ac = auStack_198;
    }
    FUN_007d7970(local_ac,local_e0,0,2);
    if (2 < DAT_008eda28) {
      local_d0 = GetPolicy(local_8c);
      local_8._0_1_ = 7;
      pcVar4 = FUN_004bc8c0;
      local_cc = local_d0;
