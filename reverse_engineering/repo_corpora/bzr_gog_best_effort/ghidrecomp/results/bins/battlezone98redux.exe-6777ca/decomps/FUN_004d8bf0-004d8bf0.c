...
void FUN_004d8bf0(int param_1,int param_2,int param_3,undefined4 param_4,undefined1 param_5)

{
  ...
  while (local_8 = param_2 * 2 + 2, local_8 < param_3) {
    cVar1 = FUN_004d4090(*(undefined4 *)(param_1 + local_8 * 4),
  ...
  FUN_004d92f0(param_1,param_2,iVar4,uVar3);
  return;
}
