...
undefined1 __thiscall FUN_00633010(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar4 = 9;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 0x6c,0x24), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0xb;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x94,0x2c), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xc4,0x28,10,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
