...
/* WARNING: Removing unreachable block (ram,0x0042afa7) */
/* WARNING: Removing unreachable block (ram,0x0042b078) */
/* WARNING: Removing unreachable block (ram,0x0042b149) */
/* WARNING: Removing unreachable block (ram,0x0042b1ac) */
/* WARNING: Removing unreachable block (ram,0x0042b232) */
/* WARNING: Removing unreachable block (ram,0x0042b2c3) */
/* WARNING: Removing unreachable block (ram,0x0042b279) */
/* WARNING: Removing unreachable block (ram,0x0042b310) */
/* WARNING: Removing unreachable block (ram,0x0042b379) */
/* WARNING: Removing unreachable block (ram,0x0042b3b3) */
/* WARNING: Removing unreachable block (ram,0x0042b422) */
/* WARNING: Removing unreachable block (ram,0x0042b4b3) */
/* WARNING: Removing unreachable block (ram,0x0042b469) */
/* WARNING: Removing unreachable block (ram,0x0042b4fd) */
/* WARNING: Removing unreachable block (ram,0x0042b09f) */
/* WARNING: Removing unreachable block (ram,0x0042b100) */
/* WARNING: Removing unreachable block (ram,0x0042b144) */
/* WARNING: Removing unreachable block (ram,0x0042afce) */
/* WARNING: Removing unreachable block (ram,0x0042b02d) */
/* WARNING: Removing unreachable block (ram,0x0042b06f) */
/* WARNING: Removing unreachable block (ram,0x0042b501) */

undefined4 FUN_0042af10(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_0042f020(param_1,1,*local_18,local_c0,param_4);
    ExceptionList = local_10;
    return param_1;
  }
  ...
  if (local_26 == '\0') {
    ...
    if (local_28 == '\0') {
      ...
      if (local_23 != '\0') {
        ...
        if (local_25 != '\0') {
          ...
          if (*local_e4 != '\0') {
            ...
            local_f4 = get();
            FUN_0042f020(param_1,0,local_f4,local_ec,param_4);
            ExceptionList = local_10;
            return param_1;
          }
          local_fc = FUN_00417780(param_3);
          local_104 = get();
          FUN_0042f020(param_1,1,local_104,local_fc,param_4);
          ExceptionList = local_10;
          return param_1;
        }
      }
      ...
      if (local_1e != '\0') {
        ...
        if (local_29 == '\0') {
          ...
          if (local_1f == '\0') goto LAB_0042ba53;
        }
        local_154 = get();
        ...
        if (*local_164 != '\0') {
          ...
          local_174 = get();
          FUN_0042f020(param_1,0,local_174,local_16c,param_4);
          ExceptionList = local_10;
          return param_1;
        }
        local_17c = FUN_00417780(param_3);
        local_184 = get();
        FUN_0042f020(param_1,1,local_184,local_17c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
    }
      ...
      if (local_21 != '\0') {
        ...
        FUN_0042f020(param_1,0,*local_84,local_7c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
      local_21 = 0;
    ...
    if (local_2e != '\0') {
      ...
      local_54 = get();
      FUN_0042f020(param_1,1,local_54,local_4c,param_4);
      ExceptionList = local_10;
      return param_1;
    }
    local_2e = 0;
