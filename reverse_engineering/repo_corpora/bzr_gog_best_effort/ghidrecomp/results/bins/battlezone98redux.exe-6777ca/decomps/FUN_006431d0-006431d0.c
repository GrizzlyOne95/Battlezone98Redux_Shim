...
undefined1 __thiscall FUN_006431d0(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar4 = 0xe;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 0x70,0x38), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0xf;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xac,0x3c), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xec,0xc,3,uVar3,uVar4), cVar2 != '\0'))
    {
      bVar1 = true;
    }
    else {
    ...
    for (local_10 = 0; local_10 < 0xf; local_10 = local_10 + 1) {
      *(undefined4 *)(param_1 + 0xac + local_10 * 4) = 0;
    }
    for (local_10 = 0; local_10 < 3; local_10 = local_10 + 1) {
      *(undefined4 *)(param_1 + 0xec + local_10 * 4) = 0;
    }
    FUN_00643750();
