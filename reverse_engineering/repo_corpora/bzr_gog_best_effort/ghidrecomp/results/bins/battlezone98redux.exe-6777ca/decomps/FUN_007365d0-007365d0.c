...
int FUN_007365d0(undefined4 param_1,int *param_2)

{
  ...
  if (local_20 == 0) {
    ...
    *in_stack_0000001c = 0;
    ...
    local_18 = local_20;
    local_30 = FUN_00736f00(&local_18);
    local_34 = 0;
    local_24 = local_30;
    local_1c = local_30;
    local_14 = local_30;
    ...
    while( true ) {
      while( true ) {
        while ((iVar1 = FUN_006d6720(&local_18), iVar1 != 0 &&
          ...
          local_28 = local_14;
          local_14 = FUN_00736f00(&local_18);
          local_3c = 0;
    ...
    FUN_00703d50();
    *in_stack_0000001c = local_30;
    *in_stack_00000020 = local_24;
    local_8 = 0xffffffff;
    FUN_00735d60();
  }
  ExceptionList = local_10;
