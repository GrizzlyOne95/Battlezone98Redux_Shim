...
void FUN_00719ae0(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (local_18 == 0) {
    ...
    local_20 = FUN_0071d8d0(*(undefined1 *)(param_1 + 4));
    local_1c = local_20;
  }
  local_24 = local_1c;
