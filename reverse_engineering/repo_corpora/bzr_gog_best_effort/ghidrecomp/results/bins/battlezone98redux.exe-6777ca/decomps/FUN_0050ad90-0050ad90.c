...
void __thiscall FUN_0050ad90(int param_1,undefined4 param_2)

{
  int iVar1;
  undefined4 uVar2;
  
  FUN_0045cc40(param_2);
  if (*(int *)(param_1 + 0x58) != 0) {
    FUN_0082c82c(*(undefined4 *)(param_1 + 0x58),0xffffd8ee,"AddObject");
