...
undefined1 __thiscall FUN_0055f090(int param_1,undefined4 param_2)

{
  ...
  if (DAT_009173b7 == '\0') {
    ...
    uVar4 = 6;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 100,0x18), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xc4,8,2,uVar3,uVar4), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
