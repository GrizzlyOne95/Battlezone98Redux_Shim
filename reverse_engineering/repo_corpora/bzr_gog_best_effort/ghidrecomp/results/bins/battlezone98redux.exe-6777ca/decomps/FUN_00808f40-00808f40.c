...
void __thiscall FUN_00808f40(undefined4 *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  cVar1 = FUN_00809970(*param_1,param_1[1],param_1[2],param_1[3],param_3);
  if (cVar1 == '\0') {
    if (*(char *)(param_1 + 4) != '\0') {
      *(undefined1 *)(param_1 + 4) = 0;
      goto LAB_00809093;
    }
    uVar2 = FUN_00809a00(local_48,param_1[2]);
    local_8 = 0;
