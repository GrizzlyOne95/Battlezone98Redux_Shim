...
void __thiscall FUN_0080dd60(undefined4 *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  cVar1 = FUN_0080f4e0(*param_1,param_1[1],param_1[2],param_1[3],param_3);
  if (cVar1 == '\0') {
    if (*(char *)(param_1 + 4) != '\0') {
      *(undefined1 *)(param_1 + 4) = 0;
      goto LAB_0080deb3;
    }
    uVar2 = FUN_0080f590(local_48,param_1[2]);
    local_8 = 0;
