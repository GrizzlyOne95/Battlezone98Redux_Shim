...
undefined4 FUN_004cea20(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  if (DAT_009173b6 == '\0') {
    ...
    for (local_c = 0; local_c < local_18; local_c = local_c + 1) {
      FUN_004ce0b0();
      iVar2 = sscanf(DAT_0260db08,"%lx",param_2 + local_c * 4);
      local_5 = iVar2 == 1;
    ...
    uVar1 = FUN_004cdda0(4,param_3,param_2);
  }
  return uVar1;
}
