...
void __fastcall FUN_004f0fd0(int param_1)

{
  ...
  FUN_0046fa60(1,2,1);
  FUN_0046fa60(2,10,1);
  FUN_0046fa60(3,0xe,*(int *)(param_1 + 0x1a0) != 0);
  ...
  if ((*(float *)(param_1 + 0x208) <= (float)fVar4) ||
     ((local_14 == 0 &&
      ((*(int *)(param_1 + 0x228) != 0 || (iVar2 = FUN_005e0fd0(0x3c,0x40), iVar2 < 0)))))) {
    local_7 = 0;
  }
  else {
    local_7 = 1;
  ...
  if ((iVar2 < iVar3) &&
     ((local_14 != 0 ||
      ((*(int *)(param_1 + 0x228) == 0 && (iVar2 = FUN_005e0fd0(0x41,0x45), -1 < iVar2)))))) {
    local_8 = 1;
  }
  else {
    local_8 = 0;
  ...
  FUN_0046fa60(7,4,*(int *)(param_1 + 0x228) == 0);
  FUN_004aefa0(8);
  FUN_0046fa60(9,0,0);
  FUN_0046fa60(8,0,0);
  FUN_0046fa60(9,0,0);
