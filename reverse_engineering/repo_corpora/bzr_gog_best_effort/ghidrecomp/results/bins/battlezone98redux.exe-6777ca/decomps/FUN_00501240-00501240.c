...
void FUN_00501240(undefined4 param_1)

{
  ...
  local_4c = (float *)FUN_004ff7a0(param_1,4);
  if (local_4c == (float *)0x0) {
    fVar4 = (float10)FUN_0082c276(param_1,4,0);
    local_54 = (float)fVar4;
    fVar4 = (float10)FUN_0082c276(param_1,5,0);
    local_50 = (float)fVar4;
    fVar4 = (float10)FUN_0082c276(param_1,6,0);
  ...
  puVar1 = (undefined4 *)
           FUN_0081ee70(local_a4,local_64,local_60,local_5c,(double)local_54,(double)local_50,
                        (double)local_58);
  puVar2 = local_48;
