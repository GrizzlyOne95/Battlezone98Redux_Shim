...
/* WARNING: Removing unreachable block (ram,0x008182de) */

undefined4 FUN_00818240(undefined4 *param_1,undefined4 param_2,__ExceptionPtr *param_3)

{
  ...
  if (cVar1 == '\0') {
    ...
    local_5 = *puVar4;
    cVar1 = FUN_00818520(local_5);
    if ((cVar1 == '\0') || (cVar1 = FUN_008185a0(local_5,0,&local_14), cVar1 == '\0')) {
      if (local_10 == 0) {
        uVar3 = 0;
      }
      else {
      ...
      while (cVar1 = FID_conflict_operator__(param_2), cVar1 == '\0') {
        ...
        cVar1 = FUN_00818520(local_5);
        if (cVar1 == '\0') break;
        cVar1 = FUN_008185a0(local_5,local_10,&local_14);
        if (cVar1 == '\0') {
          std::_Enable_shared_from_this<class___ExceptionPtr,class___ExceptionPtr>
                    ((shared_ptr<class___ExceptionPtr> *)&local_14,param_3);
          return 0;
