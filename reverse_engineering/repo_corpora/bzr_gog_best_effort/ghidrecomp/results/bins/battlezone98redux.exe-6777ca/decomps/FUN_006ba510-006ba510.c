...
void FUN_006ba510(undefined4 param_1,undefined1 *param_2,char *param_3)

{
  ...
  local_8 = 0;
  FUN_006c8970(*param_2);
  FUN_006c8970(param_2[1]);
  iVar2 = FUN_006ba480(param_2);
  std::basic_string<char,struct_std::char_traits<char>,class_std::allocator<char>_>::append
            (local_2c,param_3,iVar2 - 2);
