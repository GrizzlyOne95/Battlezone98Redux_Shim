...
void __fastcall FUN_0063c8e0(int param_1)

{
  ...
  *(undefined4 *)(param_1 + 0xa4) = uVar1;
  uVar1 = FUN_005c7e90("command");
  *(undefined4 *)(param_1 + 0x9c) = uVar1;
  uVar1 = FUN_005c7e90("factory");
  *(undefined4 *)(param_1 + 0x98) = uVar1;
  uVar1 = FUN_005c7e90("nav_portal");
  *(undefined4 *)(param_1 + 0xa8) = uVar1;
  uVar1 = FUN_0081cb40("names","Portal");
  FUN_005cd7f0(*(undefined4 *)(param_1 + 0xa8),uVar1);
  uVar1 = FUN_005c7e90("nav_base");
  *(undefined4 *)(param_1 + 0xac) = uVar1;
  FUN_005cd7f0(*(undefined4 *)(param_1 + 0xac),"Black Dog Base");
