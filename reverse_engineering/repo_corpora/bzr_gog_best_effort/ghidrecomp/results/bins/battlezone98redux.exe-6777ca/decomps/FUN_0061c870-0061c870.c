...

{
  ...
  if (DAT_009198f2 == '\0') {
    if (DAT_009198f1 == '\0') {
      ...
      DAT_008eacd4 = local_c4 * 0.5 * DAT_008eacd4 + DAT_008eacd4;
  ...
  local_ac = DAT_008eacd8 + _DAT_02a13e9c;
  if (150.0 < local_ac) {
    local_ac = 150.0;
  }
  ...
  pfVar2 = (float *)FUN_0061a370(local_e4,&DAT_02a13ea0);
  local_18 = *pfVar2;
  local_14 = pfVar2[1];
  local_10 = pfVar2[2];
  local_c = pfVar2[3];
  ...
  puVar1 = (undefined4 *)FUN_0081f530(local_d4,&DAT_008eacf8,&DAT_008eace8,local_a8 * 2.0);
  DAT_008eacf8 = *puVar1;
  DAT_008eacfc = puVar1[1];
  DAT_008ead00 = puVar1[2];
  DAT_008ead04 = puVar1[3];
  puVar3 = (uint *)FUN_0081efe0(local_164,&DAT_008eacf8);
  puVar6 = local_64;
  for (iVar5 = 0x10; iVar5 != 0; iVar5 = iVar5 + -1) {
    *puVar6 = *puVar3;
    puVar3 = puVar3 + 1;
  ...
  FUN_00820180(&local_24,&DAT_02a13e90,1,&DAT_02a13ea0);
  FUN_004fef00(local_64,(double)local_24,(double)local_20,(double)local_1c);
  puVar1 = (undefined4 *)FUN_0081fe60();
  puVar7 = local_a4;
  for (iVar5 = 0x10; iVar5 != 0; iVar5 = iVar5 + -1) {
    *puVar7 = *puVar1;
