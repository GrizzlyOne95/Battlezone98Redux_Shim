...
/* WARNING: Removing unreachable block (ram,0x004cb962) */

void FUN_004cb870(uint param_1,uint param_2)

{
  ...
  if (param_1 != 0 || param_2 != 0) {
    ...
    while( true ) {
      ...
      local_50 = *piVar4;
      if ((*(uint *)(local_50 + 0x10) == param_1) && (*(uint *)(local_50 + 0x14) == param_2)) {
        FUN_00421ec0();
        goto LAB_004cbaba;
      }
    ...
    *(undefined1 *)((int)local_40 + 5) = 0;
    ...
    if (iVar5 == 0) {
      FUN_007d6c70("Explosion \"%s\" not found\n",(int)&uStack_25 + 1);
    }
    else {
      FUN_00589430((int)&uStack_25 + 1);
      local_8 = 0;
      FUN_0047b6c0(0xca0c1378,0x92d04727,local_34,0);
      puVar6 = local_64;
      ...
      while( true ) {
        ...
        iVar5 = _stricmp((char *)local_48[3],local_34);
        if (iVar5 == 0) {
      ...
      FUN_007d6c70("Explosion \"%s\" uses unknown class label \"%s\"\n",(int)&uStack_25 + 1,local_34
                  );
      local_54 = 0;
      local_8 = 0xffffffff;
      FUN_00589530();
