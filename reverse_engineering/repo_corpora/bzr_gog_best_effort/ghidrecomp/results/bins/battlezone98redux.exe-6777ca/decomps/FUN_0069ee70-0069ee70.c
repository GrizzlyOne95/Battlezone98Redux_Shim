...
void * FUN_0069ee70(int param_1,int param_2,int param_3,int param_4)

{
  ...
  pvVar1 = malloc(((param_2 - param_1) + 1) * ((param_4 - param_3) + 1) * 4 + 4 +
                  (param_2 - param_1) * 4);
  if (pvVar1 == (void *)0x0) {
    FUN_0069ee50("allocation failure in NR_Ptr_Matrix()");
  }
