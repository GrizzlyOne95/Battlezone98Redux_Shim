...
/* WARNING: Removing unreachable block (ram,0x004b3587) */
/* WARNING: Removing unreachable block (ram,0x004b3658) */
/* WARNING: Removing unreachable block (ram,0x004b3729) */
/* WARNING: Removing unreachable block (ram,0x004b378c) */
/* WARNING: Removing unreachable block (ram,0x004b3812) */
/* WARNING: Removing unreachable block (ram,0x004b38a3) */
/* WARNING: Removing unreachable block (ram,0x004b3859) */
/* WARNING: Removing unreachable block (ram,0x004b38f0) */
/* WARNING: Removing unreachable block (ram,0x004b3959) */
/* WARNING: Removing unreachable block (ram,0x004b3993) */
/* WARNING: Removing unreachable block (ram,0x004b3a02) */
/* WARNING: Removing unreachable block (ram,0x004b3a93) */
/* WARNING: Removing unreachable block (ram,0x004b3a49) */
/* WARNING: Removing unreachable block (ram,0x004b3add) */
/* WARNING: Removing unreachable block (ram,0x004b367f) */
/* WARNING: Removing unreachable block (ram,0x004b36e0) */
/* WARNING: Removing unreachable block (ram,0x004b3724) */
/* WARNING: Removing unreachable block (ram,0x004b35ae) */
/* WARNING: Removing unreachable block (ram,0x004b360d) */
/* WARNING: Removing unreachable block (ram,0x004b364f) */
/* WARNING: Removing unreachable block (ram,0x004b3ae1) */

undefined4 FUN_004b34f0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_004b4410(param_1,1,*local_18,local_c0,param_4);
    ExceptionList = local_10;
    return param_1;
  }
  ...
  if (local_26 == '\0') {
    ...
    if (local_28 == '\0') {
      ...
      if (local_23 != '\0') {
        ...
        if (local_25 != '\0') {
          ...
          if (*local_e4 != '\0') {
            ...
            local_f4 = get();
            FUN_004b4410(param_1,0,local_f4,local_ec,param_4);
            ExceptionList = local_10;
            return param_1;
          }
          local_fc = FUN_00417780(param_3);
          local_104 = get();
          FUN_004b4410(param_1,1,local_104,local_fc,param_4);
          ExceptionList = local_10;
          return param_1;
        }
      }
      ...
      if (local_1e != '\0') {
        ...
        if (local_29 == '\0') {
          ...
          if (local_1f == '\0') goto LAB_004b4033;
        }
        local_154 = get();
        ...
        if (*local_164 != '\0') {
          ...
          local_174 = get();
          FUN_004b4410(param_1,0,local_174,local_16c,param_4);
          ExceptionList = local_10;
          return param_1;
        }
        local_17c = FUN_00417780(param_3);
        local_184 = get();
        FUN_004b4410(param_1,1,local_184,local_17c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
    }
      ...
      if (local_21 != '\0') {
        ...
        FUN_004b4410(param_1,0,*local_84,local_7c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
      local_21 = 0;
    ...
    if (local_2e != '\0') {
      ...
      local_54 = get();
      FUN_004b4410(param_1,1,local_54,local_4c,param_4);
      ExceptionList = local_10;
      return param_1;
    }
    local_2e = 0;
