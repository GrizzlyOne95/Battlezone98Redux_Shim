...
/* WARNING: Removing unreachable block (ram,0x00754a66) */

void FUN_007548f0(undefined4 param_1,char param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  while (local_48 = (char *)FUN_004242d0(local_28), *local_48 == '\0') {
    ...
    if (param_2 == '\0') {
      ...
      local_23 = FUN_00753b50(local_84,local_58);
      local_15 = local_23;
    }
    else {
      ...
      local_1f = FUN_00753b50(local_50,local_40);
      local_15 = local_1f == '\0';
  ...
  local_22 = FUN_00753b50(local_64,local_5c);
  if (local_22 == '\0') {
