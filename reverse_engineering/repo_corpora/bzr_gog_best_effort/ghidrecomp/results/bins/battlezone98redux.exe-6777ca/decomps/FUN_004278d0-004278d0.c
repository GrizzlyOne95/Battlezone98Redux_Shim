...
/* WARNING: Removing unreachable block (ram,0x00427a46) */

void FUN_004278d0(undefined4 param_1,char param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  if (local_15 != '\0') {
    ...
    if (local_20 != '\0') {
      ...
      local_4c = FUN_0042c9c0(local_94,1,local_2c,local_44,param_4);
  ...
  local_7c = FUN_0042c9c0(local_9c,local_15,local_2c,local_74,param_4);
