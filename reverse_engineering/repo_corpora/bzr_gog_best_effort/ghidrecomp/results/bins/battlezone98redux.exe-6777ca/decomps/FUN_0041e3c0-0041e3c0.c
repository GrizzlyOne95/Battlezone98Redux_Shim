...
char FUN_0041e3c0(undefined4 param_1,undefined4 param_2)

{
  ...
  while (cVar1 = FID_conflict_operator__(&local_20), cVar1 != '\0') {
    ...
    local_18 = (int *)*puVar2;
    cVar1 = (**(code **)(*local_18 + 0x1c))(param_1,param_2,1);
    if (cVar1 != '\0') {
      local_5 = '\x01';
    }
    FUN_00421f70();
  ...
  while (cVar1 = FID_conflict_operator__(&local_24), cVar1 != '\0') {
    puVar2 = (undefined4 *)get();
    local_1c = (int *)*puVar2;
    cVar1 = (**(code **)(*local_1c + 0x1c))(param_1,param_2,0);
    if (cVar1 != '\0') {
      local_5 = '\x01';
    }
