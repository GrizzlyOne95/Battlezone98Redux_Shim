...
void __fastcall FUN_005fc040(int param_1)
  ...
  if (*(int *)(param_1 + 0x38) == 0) {
    *(undefined4 *)(param_1 + 0x20) = 3;
    ...
    if (*(int *)(param_1 + 0x3c) == 0) {
      iVar2 = FUN_00462d50(*(undefined4 *)(param_1 + 0x34),0x524b4954,0xffffffff,0x41f00000);
      if (iVar2 != 0) {
        uVar3 = FUN_00462380();
      ...
      if ((iVar2 < 0x3c) || (iVar2 = FUN_0045bba0(), 0x40 < iVar2)) {
        ...
        fVar5 = (float10)(**(code **)(*(int *)(*(int *)(param_1 + 0x34) + 0x18) + 0x1c))();
        if (1.0 <= (float)fVar5) {
          *(undefined4 *)(param_1 + 0x20) = 3;
          ExceptionList = local_10;
          return;
