...

{
  ...
  *(undefined4 *)(unaff_EBP + -0x1c) = uVar1;
  if (**(int **)(unaff_EBP + -0x14) != 0) {
    FUN_004b30c0(**(undefined4 **)(unaff_EBP + -0x14),
                 *(undefined4 *)(*(int *)(unaff_EBP + -0x14) + 4));
    iVar2 = (*(int *)(*(int *)(unaff_EBP + -0x14) + 8) - **(int **)(unaff_EBP + -0x14)) / 0x18;
  ...
  *(int *)(*(int *)(unaff_EBP + -0x14) + 8) =
       *(int *)(unaff_EBP + 8) * 0x18 + *(int *)(unaff_EBP + -0x18);
  *(int *)(*(int *)(unaff_EBP + -0x14) + 4) =
       *(int *)(unaff_EBP + -0x1c) * 0x18 + *(int *)(unaff_EBP + -0x18);
