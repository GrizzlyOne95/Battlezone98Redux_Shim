...
FUN_0067bb80(_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *param_1,
...

{
  ...
  FUN_0067bc80(p_Var2);
  local_8 = 0;
  uVar3 = FUN_0067be70(param_2,param_3,param_4,local_14,uVar1);
  local_8 = 0xffffffff;
  FUN_0067b8b0();
  ExceptionList = local_10;
  return uVar3;
