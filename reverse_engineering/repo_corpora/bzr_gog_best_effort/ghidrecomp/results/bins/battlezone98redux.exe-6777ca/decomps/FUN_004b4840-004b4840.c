...
/* WARNING: Removing unreachable block (ram,0x004b49b6) */

void FUN_004b4840(undefined4 param_1,char param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (local_15 != '\0') {
    ...
    if (local_20 != '\0') {
      ...
      local_4c = FUN_004b4410(local_94,1,local_2c,local_44,param_4);
  ...
  local_7c = FUN_004b4410(local_9c,local_15,local_2c,local_74,param_4);
