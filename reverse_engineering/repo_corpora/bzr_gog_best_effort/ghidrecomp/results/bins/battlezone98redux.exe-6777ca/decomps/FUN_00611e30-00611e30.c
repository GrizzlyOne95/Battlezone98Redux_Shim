...
/* WARNING: Removing unreachable block (ram,0x00611f22) */

void FUN_00611e30(uint param_1,uint param_2)

{
  ...
  if (param_1 != 0 || param_2 != 0) {
    ...
    *(undefined1 *)((int)local_40 + 5) = 0;
    ...
    if (iVar5 == 0) {
      FUN_007d6c70("Weapon \"%s\" not found\n",(int)&uStack_25 + 1);
    }
    else {
      FUN_00589430((int)&uStack_25 + 1);
      local_8 = 0;
      FUN_0047b6c0(0xacda90ab,0x92d04727,local_34,0);
      puVar6 = local_64;
      ...
      FUN_007d6c70("Weapon \"%s\" uses unknown class label \"%s\"\n",(int)&uStack_25 + 1,local_34);
      local_54 = 0;
      local_8 = 0xffffffff;
      FUN_00589530();
    }
