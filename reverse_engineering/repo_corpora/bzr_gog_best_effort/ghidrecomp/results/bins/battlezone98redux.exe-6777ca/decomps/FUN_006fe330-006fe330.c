...
_Ref_count_base * __thiscall FUN_006fe330(_Ref_count_base *param_1,undefined4 param_2)

{
  ...
  p_Stack_34 = (_Ref_count_base *)0x6fe360;
  local_14 = param_1;
  ...
  *(undefined ***)local_14 =
  ...
  if (local_18 != 0) {
    p_Stack_34 = (_Ref_count_base *)param_2;
    uStack_38 = 0x6fe397;
    uVar1 = FUN_00417780();
    local_24 = (undefined1 *)&uStack_38;
