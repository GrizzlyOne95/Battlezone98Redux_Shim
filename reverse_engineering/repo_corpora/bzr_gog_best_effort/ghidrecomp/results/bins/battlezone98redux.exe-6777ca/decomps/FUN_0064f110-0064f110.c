...
undefined1 __thiscall FUN_0064f110(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar4 = 0x14;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 0x70,0x50), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0x11;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xc4,0x44), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x10c,0x18,6,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
