...

{
  ...
  *(undefined1 *)(unaff_EBP + -4) = 3;
  if (unaff_EBP == 0x148) {
    ...
    *(int *)(unaff_EBP + -0x78) = unaff_EBP + -0x138;
  }
  pcVar5 = FUN_004bc8c0;
  uVar1 = (**(code **)(**(int **)(unaff_EBP + -100) + 8))();
  iVar2 = (**(code **)(**(int **)(unaff_EBP + -100) + 0xc))(&DAT_0089a17c,uVar1);
  uVar1 = (**(code **)(**(int **)(unaff_EBP + -100) + 4))(&DAT_0089a17c);
  uVar1 = FUN_004bc590(*(undefined4 *)(unaff_EBP + -0x78),
                       "CGalaxyLobby::GetPlayerName, try/catch failure error no: ",uVar1);
