...
undefined4 * __thiscall FUN_006df960(undefined4 *param_1,int param_2,int param_3)

{
  ...
  FUN_006dfa50(param_2);
  *param_1 = boost::exception_detail::
             clone_impl<struct_boost::exception_detail::error_info_injector<class_std::out_of_range>_>
             ::vftable;
