...
/* WARNING: Removing unreachable block (ram,0x00760ab6) */

void FUN_00760940(undefined4 param_1,char param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  if (local_15 != '\0') {
    uVar2 = FUN_00424640(local_98);
    local_20 = FUN_004221b0(uVar2);
    if (local_20 != '\0') {
      local_24 = 1;
      local_44 = FUN_00417780(param_3);
      local_4c = FUN_00761cd0(local_94,1,local_2c,local_44,param_4);
  ...
  local_7c = FUN_00761cd0(local_9c,local_15,local_2c,local_74,param_4);
