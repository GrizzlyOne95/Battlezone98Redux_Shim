...
void FUN_00802e20(undefined4 *param_1,undefined4 *param_2,int param_3)
  ...
  if (param_3 == 0) {
    ...
    *param_2 = 0;
    ...
    bVar2 = type_info::operator==
                      ((type_info *)*param_2,
                       (type_info *)&.??@3eafc7e5ce7bf42f29415146407ee378@::RTTI_Type_Descriptor);
    if (bVar2) {
      *param_2 = *param_1;
    }
    else {
