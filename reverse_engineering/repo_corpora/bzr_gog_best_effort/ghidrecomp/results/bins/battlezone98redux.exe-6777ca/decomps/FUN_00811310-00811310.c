...
/* WARNING: Removing unreachable block (ram,0x008113ae) */

undefined4 FUN_00811310(undefined4 *param_1,undefined4 param_2,__ExceptionPtr *param_3)

{
  ...
  if (cVar1 == '\0') {
    ...
    if ((cVar1 == '\0') || (cVar1 = FUN_00812590(local_5,0,&local_1c), cVar1 == '\0')) {
      if (local_10 == 0) {
        uVar3 = 0;
      }
      else {
      ...
      while (cVar1 = FID_conflict_operator__(param_2), cVar1 == '\0') {
        ...
        cVar1 = FUN_00812500(local_5);
        if (cVar1 == '\0') break;
        cVar1 = FUN_00812590(local_5,local_10,&local_1c);
        if (cVar1 == '\0') {
          std::_Enable_shared_from_this<class___ExceptionPtr,class___ExceptionPtr>
                    ((shared_ptr<class___ExceptionPtr> *)&local_1c,param_3);
          return 0;
