...
void __thiscall FUN_00592c50(int param_1,int param_2)

{
  ...
  *(undefined4 *)(iVar4 + local_10 * 8) =
       *(undefined4 *)(*(int *)(param_1 + 0x10) + *(int *)(param_1 + 4) * 8);
  *(undefined4 *)(iVar4 + 4 + local_10 * 8) = uVar3;
  *(int *)(param_1 + 4) = *(int *)(param_1 + 4) + -1;
  fVar5 = *(float *)(*(int *)(param_1 + 0x10) + local_10 * 8);
  uVar3 = *(undefined4 *)(*(int *)(param_1 + 0x10) + 4 + local_10 * 8);
