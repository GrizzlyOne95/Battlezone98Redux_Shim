...
/* WARNING: Removing unreachable block (ram,0x0042ec96) */

void FUN_0042eb20(undefined4 param_1,char param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (local_15 != '\0') {
    ...
    if (local_20 != '\0') {
      ...
      local_4c = FUN_00431550(local_94,1,local_2c,local_44,param_4);
  ...
  local_22 = FUN_00428770(local_64,local_5c);
  if (local_22 == '\0') {
    FUN_00430380(param_4);
    local_1d = 0;
  ...
  local_7c = FUN_00431550(local_9c,local_15,local_2c,local_74,param_4);
