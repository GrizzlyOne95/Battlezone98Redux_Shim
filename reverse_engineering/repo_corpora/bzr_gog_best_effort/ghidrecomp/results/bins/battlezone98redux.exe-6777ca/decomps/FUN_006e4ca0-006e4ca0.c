...

{
  ...
  if (cVar1 == '\0') {
    ...
    if (bVar2) {
      FUN_006d08b0(0x400,"asio socket shutdown timer cancelled");
    ...
    FUN_006f1700(1,"asio handle_async_shutdown_timeout",in_stack_00000024);
    local_1c = *(undefined4 *)in_stack_00000024;
    local_18 = *(undefined4 *)(in_stack_00000024 + 4);
  }
  FUN_006d08b0(0x400,"Asio transport socket shutdown timed out");
  FUN_006d7640();
