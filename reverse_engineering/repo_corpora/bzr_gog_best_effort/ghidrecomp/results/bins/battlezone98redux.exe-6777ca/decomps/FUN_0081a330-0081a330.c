...
/* WARNING: Removing unreachable block (ram,0x0081a3c7) */
/* WARNING: Removing unreachable block (ram,0x0081a498) */
/* WARNING: Removing unreachable block (ram,0x0081a569) */
/* WARNING: Removing unreachable block (ram,0x0081a5cc) */
/* WARNING: Removing unreachable block (ram,0x0081a652) */
/* WARNING: Removing unreachable block (ram,0x0081a6e3) */
/* WARNING: Removing unreachable block (ram,0x0081a699) */
/* WARNING: Removing unreachable block (ram,0x0081a730) */
/* WARNING: Removing unreachable block (ram,0x0081a799) */
/* WARNING: Removing unreachable block (ram,0x0081a7d3) */
/* WARNING: Removing unreachable block (ram,0x0081a842) */
/* WARNING: Removing unreachable block (ram,0x0081a8d3) */
/* WARNING: Removing unreachable block (ram,0x0081a889) */
/* WARNING: Removing unreachable block (ram,0x0081a91d) */
/* WARNING: Removing unreachable block (ram,0x0081a4bf) */
/* WARNING: Removing unreachable block (ram,0x0081a520) */
/* WARNING: Removing unreachable block (ram,0x0081a564) */
/* WARNING: Removing unreachable block (ram,0x0081a3ee) */
/* WARNING: Removing unreachable block (ram,0x0081a44d) */
/* WARNING: Removing unreachable block (ram,0x0081a48f) */
/* WARNING: Removing unreachable block (ram,0x0081a921) */

undefined4 FUN_0081a330(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_0081b2d0(param_1,1,*local_18,local_c0,param_4);
    ExceptionList = local_10;
    return param_1;
  }
  ...
  if (local_26 == '\0') {
    ...
    if (local_28 == '\0') {
      ...
      if (local_23 != '\0') {
        ...
        if (local_25 != '\0') {
          ...
          if (*local_e4 != '\0') {
            ...
            local_f4 = get();
            FUN_0081b2d0(param_1,0,local_f4,local_ec,param_4);
            ExceptionList = local_10;
            return param_1;
          }
          local_fc = FUN_00417780(param_3);
          local_104 = get();
          FUN_0081b2d0(param_1,1,local_104,local_fc,param_4);
          ExceptionList = local_10;
          return param_1;
        }
      }
      ...
      if (local_1e != '\0') {
        ...
        if (local_29 == '\0') {
          ...
          if (local_1f == '\0') goto LAB_0081ae73;
        }
        local_154 = get();
        ...
        if (*local_164 != '\0') {
          ...
          local_174 = get();
          FUN_0081b2d0(param_1,0,local_174,local_16c,param_4);
          ExceptionList = local_10;
          return param_1;
        }
        local_17c = FUN_00417780(param_3);
        local_184 = get();
        FUN_0081b2d0(param_1,1,local_184,local_17c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
    }
      ...
      if (local_21 != '\0') {
        ...
        FUN_0081b2d0(param_1,0,*local_84,local_7c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
      local_21 = 0;
    ...
    if (local_2e != '\0') {
      ...
      local_54 = get();
      FUN_0081b2d0(param_1,1,local_54,local_4c,param_4);
      ExceptionList = local_10;
      return param_1;
    }
    local_2e = 0;
