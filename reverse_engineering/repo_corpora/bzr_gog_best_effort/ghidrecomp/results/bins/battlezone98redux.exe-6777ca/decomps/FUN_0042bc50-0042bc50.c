...
/* WARNING: Removing unreachable block (ram,0x0042bce7) */
/* WARNING: Removing unreachable block (ram,0x0042bdb8) */
/* WARNING: Removing unreachable block (ram,0x0042be89) */
/* WARNING: Removing unreachable block (ram,0x0042beec) */
/* WARNING: Removing unreachable block (ram,0x0042bf72) */
/* WARNING: Removing unreachable block (ram,0x0042c003) */
/* WARNING: Removing unreachable block (ram,0x0042bfb9) */
/* WARNING: Removing unreachable block (ram,0x0042c050) */
/* WARNING: Removing unreachable block (ram,0x0042c0b9) */
/* WARNING: Removing unreachable block (ram,0x0042c0f3) */
/* WARNING: Removing unreachable block (ram,0x0042c162) */
/* WARNING: Removing unreachable block (ram,0x0042c1f3) */
/* WARNING: Removing unreachable block (ram,0x0042c1a9) */
/* WARNING: Removing unreachable block (ram,0x0042c23d) */
/* WARNING: Removing unreachable block (ram,0x0042bddf) */
/* WARNING: Removing unreachable block (ram,0x0042be40) */
/* WARNING: Removing unreachable block (ram,0x0042be84) */
/* WARNING: Removing unreachable block (ram,0x0042bd0e) */
/* WARNING: Removing unreachable block (ram,0x0042bd6d) */
/* WARNING: Removing unreachable block (ram,0x0042bdaf) */
/* WARNING: Removing unreachable block (ram,0x0042c241) */

undefined4 FUN_0042bc50(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_0042f840(param_1,1,*local_18,local_c0,param_4);
    ExceptionList = local_10;
    return param_1;
  }
  ...
  if (local_26 == '\0') {
    ...
    if (local_28 == '\0') {
      ...
      if (local_23 != '\0') {
        ...
        if (local_25 != '\0') {
          ...
          if (*local_e4 != '\0') {
            ...
            local_f4 = get();
            FUN_0042f840(param_1,0,local_f4,local_ec,param_4);
            ExceptionList = local_10;
            return param_1;
          }
          local_fc = FUN_00417780(param_3);
          local_104 = get();
          FUN_0042f840(param_1,1,local_104,local_fc,param_4);
          ExceptionList = local_10;
          return param_1;
        }
      }
      ...
      if (local_1e != '\0') {
        ...
        if (local_29 == '\0') {
          ...
          if (local_1f == '\0') goto LAB_0042c793;
        }
        local_154 = get();
        ...
        if (*local_164 != '\0') {
          ...
          local_174 = get();
          FUN_0042f840(param_1,0,local_174,local_16c,param_4);
          ExceptionList = local_10;
          return param_1;
        }
        local_17c = FUN_00417780(param_3);
        local_184 = get();
        FUN_0042f840(param_1,1,local_184,local_17c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
    }
      ...
      if (local_21 != '\0') {
        ...
        FUN_0042f840(param_1,0,*local_84,local_7c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
      local_21 = 0;
    ...
    if (local_2e != '\0') {
      ...
      local_54 = get();
      FUN_0042f840(param_1,1,local_54,local_4c,param_4);
      ExceptionList = local_10;
      return param_1;
    }
    local_2e = 0;
