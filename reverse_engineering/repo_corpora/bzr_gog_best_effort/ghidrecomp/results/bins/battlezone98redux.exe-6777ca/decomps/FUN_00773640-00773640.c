...
void FUN_00773640(undefined4 param_1,undefined4 param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  while (local_8 = (param_3 + -1) / 2, param_4 < param_3) {
    ...
    uVar2 = FUN_00772230(uVar3);
    cVar1 = FUN_007681a0(uVar2,uVar3);
    if (cVar1 == '\0') break;
