...

{
  ...
  *(undefined4 *)(unaff_EBP + -0x20) = uVar1;
  if (**(int **)(unaff_EBP + -0x18) != 0) {
    ...
    iVar2 = (*(int *)(*(int *)(unaff_EBP + -0x18) + 8) - **(int **)(unaff_EBP + -0x18)) / 0x50;
  ...
  *(int *)(*(int *)(unaff_EBP + -0x18) + 8) =
       *(int *)(unaff_EBP + 8) * 0x50 + *(int *)(unaff_EBP + -0x1c);
  *(int *)(*(int *)(unaff_EBP + -0x18) + 4) =
       *(int *)(unaff_EBP + -0x20) * 0x50 + *(int *)(unaff_EBP + -0x1c);
