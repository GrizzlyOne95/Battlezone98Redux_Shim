...
FUN_00716470(_Ref_count_base *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
            undefined4 param_5)

{
  ...
  p_Stack_38 = (_Ref_count_base *)0x7164a0;
  local_14 = param_1;
  std::_Ref_count_base::_Ref_count_base(param_1);
  local_8 = 0;
  *(undefined ***)local_14 =
       std::
       _Ref_count_obj<class_websocketpp::processor::hybi07<struct_websocketpp::config::asio_client>_>
       ::vftable;
  ...
  if (local_18 != 0) {
    ...
    uStack_3c = 0x7164d7;
    FUN_00417780();
    p_Stack_38 = (_Ref_count_base *)0x7164e1;
