...
FUN_00771600(pair<class___FrameHandler3::TryBlockMap::iterator,class___FrameHandler3::TryBlockMap::iterator>
...

{
  ...
  FUN_00772310(param_2,param_3,local_2c,local_28,*puVar4,puVar4[1],uVar9);
  local_c = local_2c;
  local_8 = local_28;
  ...
  while (bVar1 = __FrameHandler3::TryBlockMap::iterator::operator<
    ...
    uVar6 = FUN_00772160(uVar5);
    cVar2 = FUN_00768120(uVar6,uVar5);
    if (cVar2 != '\0') break;
...
LAB_00771820:
      while (bVar1 = __FrameHandler3::TryBlockMap::iterator::operator<
        ...
        if (cVar2 == '\0') {
          ...
          if (bVar1) {
            ...
            FUN_00772490(local_c,local_8,*puVar4,puVar4[1]);
          }
        }
        FUN_00730830();
      }
      ...
      if (bVar1) {
        ...
        if (bVar1) {
          FUN_00772490(local_c,local_8,local_14,local_10);
        }
        FUN_00730810();
        ...
        FUN_00772490(*puVar4,puVar4[1],uVar6,uVar5);
      }
      else {
        bVar1 = __FrameHandler3::HandlerMap::iterator::operator==
        ...
        if (bVar1) {
          ...
          bVar1 = __FrameHandler3::HandlerMap::iterator::operator!=(piVar8,piVar7);
          if (bVar1) {
            FUN_00772490(local_1c,local_18,local_c,local_8);
          }
    ...
    if (cVar2 == '\0') {
      ...
      if (bVar1) {
        ...
        FUN_00772490(*puVar4,puVar4[1],uVar5,uVar6);
      }
    }
    FUN_00730810();
  } while( true );
