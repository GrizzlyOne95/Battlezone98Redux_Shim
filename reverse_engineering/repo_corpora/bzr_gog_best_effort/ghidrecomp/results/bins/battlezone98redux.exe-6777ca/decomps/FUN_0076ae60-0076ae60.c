...
void __thiscall FUN_0076ae60(int param_1,int param_2)

{
  ...
  if ((DAT_00915568 == 0) &&
     ((*(int *)(param_1 + 0x8c) != 0 ||
      (cVar1 = FUN_00427310(param_1 + 0x90,param_2 + 0x7c,local_14), cVar1 == '\0')))) {
    *(undefined4 *)(local_120 + 0x8c) = 0;
    FID_conflict_operator_(param_2 + 0x7c);
    FUN_00434420();
    FUN_00820dd0();
    iVar2 = FUN_0081dee0();
    ...
    while( true ) {
      ...
      FUN_004fbb60();
      uVar4 = 0;
      iVar2 = FUN_0076fa30(0);
      FUN_00666890(iVar2 + 0x18,uVar4);
      local_8._0_1_ = 3;
      ...
      FUN_00820e00(uVar4);
      iVar2 = FUN_0076fa30();
      FUN_006679c0(local_128,iVar2 + 0x18);
    ...
    uVar4 = FUN_0041f870();
    FUN_00820e00(uVar4);
    FUN_006679c0(local_128,param_2 + 0x7c);
