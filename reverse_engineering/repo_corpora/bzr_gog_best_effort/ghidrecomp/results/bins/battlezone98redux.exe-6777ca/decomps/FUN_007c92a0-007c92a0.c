...
/* WARNING: Removing unreachable block (ram,0x007c9308) */

_Container_base0 * __thiscall FUN_007c92a0(_Container_base0 *param_1,_Container_base0 *param_2)

{
  ...
  if (param_1 != param_2) {
    ...
    if (cVar1 != '\0') {
      FUN_0041ff50();
      p_Var4 = (_Container_base0 *)FUN_007c94c6();
      return p_Var4;
    }
    uVar5 = size();
    uVar6 = size();
    if (uVar6 <= uVar5) {
      ...
      iVar7 = size();
      *(int *)(param_1 + 4) = *(int *)param_1 + iVar7 * 4;
      p_Var4 = (_Container_base0 *)FUN_007c94c6();
      return p_Var4;
    }
    ...
    if (*(int *)param_1 != 0) {
      ...
      iVar7 = *(int *)(param_1 + 8) - *(int *)param_1 >> 2;
    ...
    if (cVar1 != '\0') {
      ...
      *(undefined4 *)(param_1 + 4) = uVar2;
      p_Var4 = (_Container_base0 *)FUN_007c94b6();
      return p_Var4;
    }
  }
  ExceptionList = local_10;
