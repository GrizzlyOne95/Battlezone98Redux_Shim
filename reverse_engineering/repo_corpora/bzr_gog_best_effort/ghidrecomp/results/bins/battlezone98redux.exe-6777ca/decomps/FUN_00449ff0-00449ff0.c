...
undefined4 * __thiscall FUN_00449ff0(undefined4 *param_1,int param_2,int param_3)

{
  ...
  FUN_0044a0e0(param_2);
  *param_1 = boost::exception_detail::
             clone_impl<struct_boost::exception_detail::error_info_injector<class_boost::thread_resource_error>_>
             ::vftable;
