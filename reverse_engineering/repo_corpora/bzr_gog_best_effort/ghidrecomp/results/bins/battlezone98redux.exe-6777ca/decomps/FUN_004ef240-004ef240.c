...
void FUN_004ef240(undefined4 *param_1,int *param_2)
  ...
  *(uint *)(*(int *)(local_24 + 0x218) + 0xdc) = local_34;
  if ((*(byte *)(local_28 + 4) & 8) == 0) {
    if ((*(byte *)(local_28 + 4) & 0x10) == 0) {
      FUN_0062de80(*(undefined4 *)(local_24 + 0xdc),1);
      *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) =
           *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) & 0xfffffbff;
    }
    else {
      FUN_0062de40(*(undefined4 *)(local_24 + 0xdc),1);
      *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) =
           *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) & 0xfffffffe;
      *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) =
           *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) | 0x400;
    }
  }
  else {
    *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) = *(uint *)(*(int *)(local_24 + 0xdc) + 0x14) | 1;
  }
