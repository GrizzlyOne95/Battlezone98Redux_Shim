/*
 * Entry: 0047c267
 * Name: std::_Tree<std::_Tmap_traits<unsigned_long,DistributedObject_*,std::less<unsigned_long>,std::allocator<std::pair<unsigned_long_const_,DistributedObject_*>_>,0>_>::_Right
 ...
 * Signature: _Node * * _Right(_Node * param_1)
...
::_Right(_Node *param_1)

{
  return &param_1->_Right;
}
