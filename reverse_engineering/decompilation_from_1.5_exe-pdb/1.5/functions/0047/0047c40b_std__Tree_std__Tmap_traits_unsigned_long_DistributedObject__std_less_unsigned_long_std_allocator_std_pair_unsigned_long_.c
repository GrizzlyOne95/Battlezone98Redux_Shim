/*
 * Entry: 0047c40b
 * Name: std::_Tree<std::_Tmap_traits<unsigned_long,DistributedObject_*,std::less<unsigned_long>,std::allocator<std::pair<unsigned_long_const_,DistributedObject_*>_>,0>_>::_Isnil
 ...
 * Signature: char * _Isnil(_Node * param_1)
...
::_Isnil(_Node *param_1)

{
  return &param_1->_Isnil;
}
