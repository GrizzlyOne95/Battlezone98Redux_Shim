/*
 * Entry: 0047c281
 * Name: std::vector<DistributedObject_*,std::allocator<DistributedObject_*>_>::_Xlen
...
void __cdecl std::vector<DistributedObject_*,std::allocator<DistributedObject_*>_>::_Xlen(void)
