/*
 * Entry: 0040e544
 * Name: std::list<AttackerInfo,std::allocator<AttackerInfo>_>::begin
 * Namespace: std::list<AttackerInfo,std::allocator<AttackerInfo>_>
 * Signature: _Iterator<1> begin(list<AttackerInfo,std::allocator<AttackerInfo>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<AttackerInfo,std::allocator<AttackerInfo>_>::begin
