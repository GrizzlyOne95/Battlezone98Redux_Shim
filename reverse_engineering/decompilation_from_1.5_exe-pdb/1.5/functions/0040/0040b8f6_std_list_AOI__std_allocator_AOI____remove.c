/*
 * Entry: 0040b8f6
 * Name: std::list<AOI_*,std::allocator<AOI_*>_>::remove
 * Namespace: std::list<AOI_*,std::allocator<AOI_*>_>
 * Signature: void remove(list<AOI_*,std::allocator<AOI_*>_> * this, AOI * * param_1)
 * Symbol source: IMPORTED
 * Export status: ok
 */

void __thiscall
std::list<AOI_*,std::allocator<AOI_*>_>::remove
