/*
 * Entry: 0040e4f3
 * Name: std::list<AttackGroup_*,std::allocator<AttackGroup_*>_>::_Const_iterator<1>::_Const_iterator<1>
 * Namespace: std::list<AttackGroup_*,std::allocator<AttackGroup_*>_>::_Const_iterator<1>
 * Signature: _Const_iterator<1> * _Const_iterator<1>(_Const_iterator<1> * this, _Node * param_1, list<AttackGroup_*,std::allocator<AttackGroup_*>_> * param_2)
...

{
  this->_padding_ = 0;
  this->_Ptr = param_1;
  if (param_2 == (list<AttackGroup_*,std::allocator<AttackGroup_*>_> *)0x0) {
