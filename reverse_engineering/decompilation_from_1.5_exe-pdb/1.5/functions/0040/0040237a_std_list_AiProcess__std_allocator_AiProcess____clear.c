/*
 * Entry: 0040237a
 * Name: std::list<AiProcess_*,std::allocator<AiProcess_*>_>::clear
 * Namespace: std::list<AiProcess_*,std::allocator<AiProcess_*>_>
 * Signature: void clear(list<AiProcess_*,std::allocator<AiProcess_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

void __thiscall
std::list<AiProcess_*,std::allocator<AiProcess_*>_>::clear
