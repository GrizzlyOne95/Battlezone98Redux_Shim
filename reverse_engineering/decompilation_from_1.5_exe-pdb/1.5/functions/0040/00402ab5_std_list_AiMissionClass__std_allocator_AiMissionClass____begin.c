/*
 * Entry: 00402ab5
 * Name: std::list<AiMissionClass_*,std::allocator<AiMissionClass_*>_>::begin
 * Namespace: std::list<AiMissionClass_*,std::allocator<AiMissionClass_*>_>
 * Signature: _Iterator<1> begin(list<AiMissionClass_*,std::allocator<AiMissionClass_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<AiMissionClass_*,std::allocator<AiMissionClass_*>_>::begin
