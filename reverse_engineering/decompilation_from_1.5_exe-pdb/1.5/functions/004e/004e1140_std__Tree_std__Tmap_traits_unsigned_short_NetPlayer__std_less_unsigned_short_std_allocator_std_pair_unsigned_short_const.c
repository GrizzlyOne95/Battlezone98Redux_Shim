/*
 * Entry: 004e1140
 * Name: std::_Tree<std::_Tmap_traits<unsigned_short,NetPlayer_*,std::less<unsigned_short>,std::allocator<std::pair<unsigned_short_const_,NetPlayer_*>_>,0>_>::_Key
 ...
 * Signature: ushort * _Key(_Node * param_1)
