/*
 * Entry: 0052e8f9
 * Name: std::vector<ExplosionClass_*,std::allocator<ExplosionClass_*>_>::_Xlen
...
void __cdecl std::vector<ExplosionClass_*,std::allocator<ExplosionClass_*>_>::_Xlen(void)
