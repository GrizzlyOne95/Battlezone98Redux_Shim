/*
 * Entry: 0052e191
 * Name: std::list<Explosion_*,std::allocator<Explosion_*>_>::begin
 * Namespace: std::list<Explosion_*,std::allocator<Explosion_*>_>
 * Signature: _Iterator<1> begin(list<Explosion_*,std::allocator<Explosion_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<Explosion_*,std::allocator<Explosion_*>_>::begin
