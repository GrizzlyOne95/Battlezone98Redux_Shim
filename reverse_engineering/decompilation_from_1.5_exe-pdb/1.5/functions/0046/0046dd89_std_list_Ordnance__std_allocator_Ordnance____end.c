/*
 * Entry: 0046dd89
 * Name: std::list<Ordnance_*,std::allocator<Ordnance_*>_>::end
 * Namespace: std::list<Ordnance_*,std::allocator<Ordnance_*>_>
 * Signature: _Iterator<1> end(list<Ordnance_*,std::allocator<Ordnance_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<Ordnance_*,std::allocator<Ordnance_*>_>::end
