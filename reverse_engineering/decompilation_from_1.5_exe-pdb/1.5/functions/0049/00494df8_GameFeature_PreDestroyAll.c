/*
 * Entry: 00494df8
 * Name: GameFeature_PreDestroyAll
 * Namespace: Global
 * Signature: void GameFeature_PreDestroyAll(void)
 * Symbol source: IMPORTED
 * Export status: ok
 */

void __cdecl GameFeature_PreDestroyAll(void)
