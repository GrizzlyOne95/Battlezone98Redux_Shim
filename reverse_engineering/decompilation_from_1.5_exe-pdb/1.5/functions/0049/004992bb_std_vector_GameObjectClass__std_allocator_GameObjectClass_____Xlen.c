/*
 * Entry: 004992bb
 * Name: std::vector<GameObjectClass_*,std::allocator<GameObjectClass_*>_>::_Xlen
...
void __cdecl std::vector<GameObjectClass_*,std::allocator<GameObjectClass_*>_>::_Xlen(void)
