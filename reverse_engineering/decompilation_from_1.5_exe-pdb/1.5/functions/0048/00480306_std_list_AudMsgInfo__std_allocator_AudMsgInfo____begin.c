/*
 * Entry: 00480306
 * Name: std::list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_>::begin
 * Namespace: std::list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_>
 * Signature: _Iterator<1> begin(list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_>::begin
