/*
 * Entry: 0048031c
 * Name: std::list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_>::end
 * Namespace: std::list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_>
 * Signature: _Iterator<1> end(list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<AudMsgInfo_*,std::allocator<AudMsgInfo_*>_>::end
