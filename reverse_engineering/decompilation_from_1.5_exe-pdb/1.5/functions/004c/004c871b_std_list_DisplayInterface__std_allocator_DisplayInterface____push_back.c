/*
 * Entry: 004c871b
 * Name: std::list<DisplayInterface_*,std::allocator<DisplayInterface_*>_>::push_back
 * Namespace: std::list<DisplayInterface_*,std::allocator<DisplayInterface_*>_>
 * Signature: void push_back(list<DisplayInterface_*,std::allocator<DisplayInterface_*>_> * this, DisplayInterface * * param_1)
 * Symbol source: IMPORTED
 * Export status: ok
 */

void __thiscall
std::list<DisplayInterface_*,std::allocator<DisplayInterface_*>_>::push_back
