/*
 * Entry: 004c87b7
 * Name: std::list<DisplayViewInfo_*,std::allocator<DisplayViewInfo_*>_>::push_back
 * Namespace: std::list<DisplayViewInfo_*,std::allocator<DisplayViewInfo_*>_>
 * Signature: void push_back(list<DisplayViewInfo_*,std::allocator<DisplayViewInfo_*>_> * this, DisplayViewInfo * * param_1)
