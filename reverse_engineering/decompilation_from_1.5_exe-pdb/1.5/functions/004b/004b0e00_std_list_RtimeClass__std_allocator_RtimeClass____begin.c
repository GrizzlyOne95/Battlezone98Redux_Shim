/*
 * Entry: 004b0e00
 * Name: std::list<RtimeClass_*,std::allocator<RtimeClass_*>_>::begin
 * Namespace: std::list<RtimeClass_*,std::allocator<RtimeClass_*>_>
 * Signature: _Iterator<1> begin(list<RtimeClass_*,std::allocator<RtimeClass_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<RtimeClass_*,std::allocator<RtimeClass_*>_>::begin
