/*
 * Entry: 00411ff1
 * Name: std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>::_Const_iterator<1>::_Const_iterator<1>
 * Namespace: std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>::_Const_iterator<1>
 * Signature: _Const_iterator<1> * _Const_iterator<1>(_Const_iterator<1> * this, _Node * param_1, list<FollowGroup_*,std::allocator<FollowGroup_*>_> * param_2)
...

{
  this->_padding_ = 0;
  this->_Ptr = param_1;
  if (param_2 == (list<FollowGroup_*,std::allocator<FollowGroup_*>_> *)0x0) {
