/*
 * Entry: 0041229e
 * Name: std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>::begin
 * Namespace: std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>
 * Signature: _Iterator<1> begin(list<FollowGroup_*,std::allocator<FollowGroup_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>::begin
