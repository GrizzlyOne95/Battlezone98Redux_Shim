/*
 * Entry: 00411d07
 * Name: std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>::clear
 * Namespace: std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>
 * Signature: void clear(list<FollowGroup_*,std::allocator<FollowGroup_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

void __thiscall
std::list<FollowGroup_*,std::allocator<FollowGroup_*>_>::clear
