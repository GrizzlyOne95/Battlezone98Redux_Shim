/*
 * Entry: 00412042
 * Name: std::list<FollowerInfo,std::allocator<FollowerInfo>_>::begin
 * Namespace: std::list<FollowerInfo,std::allocator<FollowerInfo>_>
 * Signature: _Iterator<1> begin(list<FollowerInfo,std::allocator<FollowerInfo>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<FollowerInfo,std::allocator<FollowerInfo>_>::begin
