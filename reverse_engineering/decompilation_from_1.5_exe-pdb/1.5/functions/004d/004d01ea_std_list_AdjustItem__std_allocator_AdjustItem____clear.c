/*
 * Entry: 004d01ea
 * Name: std::list<AdjustItem_*,std::allocator<AdjustItem_*>_>::clear
 * Namespace: std::list<AdjustItem_*,std::allocator<AdjustItem_*>_>
 * Signature: void clear(list<AdjustItem_*,std::allocator<AdjustItem_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

void __thiscall
std::list<AdjustItem_*,std::allocator<AdjustItem_*>_>::clear
