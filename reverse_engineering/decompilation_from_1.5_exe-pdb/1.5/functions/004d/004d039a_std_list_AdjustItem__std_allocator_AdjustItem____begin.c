/*
 * Entry: 004d039a
 * Name: std::list<AdjustItem_*,std::allocator<AdjustItem_*>_>::begin
 * Namespace: std::list<AdjustItem_*,std::allocator<AdjustItem_*>_>
 * Signature: _Iterator<1> begin(list<AdjustItem_*,std::allocator<AdjustItem_*>_> * this)
 * Symbol source: IMPORTED
 * Export status: ok
 */

_Iterator<1> __thiscall
std::list<AdjustItem_*,std::allocator<AdjustItem_*>_>::begin
