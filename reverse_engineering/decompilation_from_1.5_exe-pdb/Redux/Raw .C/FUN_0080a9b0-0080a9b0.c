...
void __thiscall FUN_0080a9b0(undefined4 *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  cVar1 = FUN_0080b140(*param_1,param_1[1],param_1[2],param_1[3],param_3);
  if (cVar1 == '\0') {
    if (*(char *)(param_1 + 4) != '\0') {
      *(undefined1 *)(param_1 + 4) = 0;
      goto LAB_0080ab03;
    }
    uVar2 = FUN_0080b070(local_48,param_1[2]);
    local_8 = 0;
