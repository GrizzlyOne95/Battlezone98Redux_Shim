...
void __thiscall FUN_006f4cc0(int param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  *(int *)(param_1 + 0x24) = param_4;
  ...
  if (param_4 == 1) {
    ...
    FUN_006f66c0(uVar2);
LAB_006f4cff:
    FUN_006ff2e0(local_8 + 4,local_8);
  }
  else {
    *(int *)(param_1 + 0x28) = *(int *)(param_1 + 0x28) + param_3;
    ...
    if ((cVar1 == '\0') || (param_3 != 0)) {
      ...
      if (cVar1 == '\0') goto LAB_006f4cff;
    }
    FUN_006fec50(param_2,local_8 + 0x28);
  }
  return;
}
