...
/* WARNING: Removing unreachable block (ram,0x0048ded6) */

void FUN_0048dd60(undefined4 param_1,char param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (local_15 != '\0') {
    ...
    if (local_20 != '\0') {
      ...
      local_4c = FUN_0048d930(local_94,1,local_2c,local_44,param_4);
  ...
  local_7c = FUN_0048d930(local_9c,local_15,local_2c,local_74,param_4);
