...
int FUN_0066a490(undefined4 param_1)

{
  ...
  if (cVar1 == '\0') {
    ...
    cVar1 = FUN_0066bb50(uVar2,uVar3);
    if (cVar1 == '\0') goto LAB_0066a52f;
  }
  local_14 = local_10[0];
  uVar2 = std::allocator<char>::allocator<char>(&local_6);
  uVar3 = FUN_00427550(local_1c,param_1,uVar2);
  puVar4 = (undefined4 *)FUN_0066eb90(local_20,local_14,&DAT_025f8df4,uVar3,uVar2);
  local_10[0] = *puVar4;
LAB_0066a52f:
  iVar5 = FUN_00422150();
  return iVar5 + 0x1c;
