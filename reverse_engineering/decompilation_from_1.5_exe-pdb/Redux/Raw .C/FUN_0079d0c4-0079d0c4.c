...

{
  ...
  *(int *)(unaff_EBP + -0x1c) = iVar1 + *(int *)(unaff_EBP + -0x1c);
  if (**(int **)(unaff_EBP + -0x18) != 0) {
    ...
    iVar1 = (*(int *)(*(int *)(unaff_EBP + -0x18) + 8) - **(int **)(unaff_EBP + -0x18)) / 0x18;
  ...
  *(int *)(*(int *)(unaff_EBP + -0x18) + 8) =
       *(int *)(unaff_EBP + -0x28) * 0x18 + *(int *)(unaff_EBP + -0x20);
  *(int *)(*(int *)(unaff_EBP + -0x18) + 4) =
       *(int *)(unaff_EBP + -0x1c) * 0x18 + *(int *)(unaff_EBP + -0x20);
