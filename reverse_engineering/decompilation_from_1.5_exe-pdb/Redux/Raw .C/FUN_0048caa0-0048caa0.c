...
/* WARNING: Removing unreachable block (ram,0x0048cb37) */
/* WARNING: Removing unreachable block (ram,0x0048cc08) */
/* WARNING: Removing unreachable block (ram,0x0048ccd9) */
/* WARNING: Removing unreachable block (ram,0x0048cd3c) */
/* WARNING: Removing unreachable block (ram,0x0048cdc2) */
/* WARNING: Removing unreachable block (ram,0x0048ce53) */
/* WARNING: Removing unreachable block (ram,0x0048ce09) */
/* WARNING: Removing unreachable block (ram,0x0048cea0) */
/* WARNING: Removing unreachable block (ram,0x0048cf09) */
/* WARNING: Removing unreachable block (ram,0x0048cf43) */
/* WARNING: Removing unreachable block (ram,0x0048cfb2) */
/* WARNING: Removing unreachable block (ram,0x0048d043) */
/* WARNING: Removing unreachable block (ram,0x0048cff9) */
/* WARNING: Removing unreachable block (ram,0x0048d08d) */
/* WARNING: Removing unreachable block (ram,0x0048cc2f) */
/* WARNING: Removing unreachable block (ram,0x0048cc90) */
/* WARNING: Removing unreachable block (ram,0x0048ccd4) */
/* WARNING: Removing unreachable block (ram,0x0048cb5e) */
/* WARNING: Removing unreachable block (ram,0x0048cbbd) */
/* WARNING: Removing unreachable block (ram,0x0048cbff) */
/* WARNING: Removing unreachable block (ram,0x0048d091) */

undefined4 FUN_0048caa0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_0048e120(param_1,1,*local_18,local_c0,param_4);
    ExceptionList = local_10;
    return param_1;
  }
  ...
  if (local_26 == '\0') {
    ...
    if (local_28 == '\0') {
      ...
      if (local_23 != '\0') {
        ...
        if (local_25 != '\0') {
          ...
          if (*local_e4 != '\0') {
            ...
            local_f4 = get();
            FUN_0048e120(param_1,0,local_f4,local_ec,param_4);
            ExceptionList = local_10;
            return param_1;
          }
          local_fc = FUN_00417780(param_3);
          local_104 = get();
          FUN_0048e120(param_1,1,local_104,local_fc,param_4);
          ExceptionList = local_10;
          return param_1;
        }
      }
      ...
      if (local_1e != '\0') {
        ...
        if (local_29 == '\0') {
          ...
          if (local_1f == '\0') goto LAB_0048d5e3;
        }
        local_154 = get();
        ...
        if (*local_164 != '\0') {
          ...
          local_174 = get();
          FUN_0048e120(param_1,0,local_174,local_16c,param_4);
          ExceptionList = local_10;
          return param_1;
        }
        local_17c = FUN_00417780(param_3);
        local_184 = get();
        FUN_0048e120(param_1,1,local_184,local_17c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
    }
      ...
      if (local_21 != '\0') {
        ...
        FUN_0048e120(param_1,0,*local_84,local_7c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
      local_21 = 0;
    ...
    if (local_2e != '\0') {
      ...
      local_54 = get();
      FUN_0048e120(param_1,1,local_54,local_4c,param_4);
      ExceptionList = local_10;
      return param_1;
    }
    local_2e = 0;
