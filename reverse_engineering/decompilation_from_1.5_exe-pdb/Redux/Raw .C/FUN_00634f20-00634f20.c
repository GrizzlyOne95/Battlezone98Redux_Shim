...
undefined1 __thiscall FUN_00634f20(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar3 = 0x18;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x9c,0x60), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x100,0x24,9,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
