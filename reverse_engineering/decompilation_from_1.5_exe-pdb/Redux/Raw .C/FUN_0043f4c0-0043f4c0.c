...
undefined4 FUN_0043f4c0(int param_1)

{
  ...
  if ((param_1 < 0) || (1 < param_1)) {
    ...
    if (*(int *)(&DAT_0260cae4 + param_1 * 0x310) == 0) {
      FUN_007d6a70("OggManager::Stop index %d has NO pStreamingSound but is playing. Attempting to fix\n"
                   ,param_1);
    ...
    FUN_007d6a70("Stopping Music Playback Index %d\n",param_1);
    uVar1 = 1;
  }
  return uVar1;
}
