...
/* WARNING: Removing unreachable block (ram,0x00427db6) */

void FUN_00427c40(undefined4 param_1,char param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  while (local_48 = (char *)FUN_004242d0(local_28), *local_48 == '\0') {
    ...
    if (param_2 == '\0') {
      ...
      local_23 = FUN_00422f40(local_84,local_58);
      local_15 = local_23;
    }
    else {
      ...
      local_1f = FUN_00422f40(local_50,local_40);
      local_15 = local_1f == '\0';
  ...
  if (local_15 != '\0') {
    ...
    if (local_20 != '\0') {
      ...
      local_4c = FUN_0042cdf0(local_94,1,local_2c,local_44,param_4);
  ...
  local_22 = FUN_00422f40(local_64,local_5c);
  if (local_22 == '\0') {
  ...
  local_7c = FUN_0042cdf0(local_9c,local_15,local_2c,local_74,param_4);
