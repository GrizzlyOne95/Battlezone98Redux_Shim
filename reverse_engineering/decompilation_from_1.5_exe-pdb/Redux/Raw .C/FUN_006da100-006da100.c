...
undefined4 FUN_006da100(undefined4 param_1)

{
  uint uVar1;
  _ExceptionHolder *p_Var2;
  _Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *p_Var3;
  ...
  if (local_14 == (void *)0x0) {
    ...
    local_18 = (_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *)FUN_006e87f0(uVar1);
  }
  local_24 = local_18;
  local_8 = 0xffffffff;
  local_1c = local_18;
  ...
  local_8 = 1;
  p_Var3 = local_1c;
  p_Var2 = std::_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder>::_Getptr(local_1c);
  _Resetp0<>(p_Var2,p_Var3);
  shared_ptr<>(local_2c);
  local_20 = local_20 | 1;
  local_8 = 0xffffffff;
  FUN_006ca8c0();
