...
void __fastcall FUN_004eb590(int param_1)

{
  ...
  for (local_200 = 0; local_200 < 5; local_200 = local_200 + 1) {
    local_1fc = FUN_00417f60(local_200);
    if (local_1fc != 0) {
      puVar1 = (undefined4 *)
               FUN_0062e070(local_25c,*(undefined4 *)(local_1fc + 0x14),
                            *(undefined4 *)(local_204 + 0xf4));
      puVar3 = local_b8;
      for (iVar2 = 0x10; iVar2 != 0; iVar2 = iVar2 + -1) {
        *puVar3 = *puVar1;
        puVar1 = puVar1 + 1;
      ...
      local_48 = 0;
      local_50 = 0;
      puVar1 = (undefined4 *)FUN_008203f0(local_29c,local_78);
      puVar3 = local_1f8;
      for (iVar2 = 0x10; iVar2 != 0; iVar2 = iVar2 + -1) {
        *puVar3 = *puVar1;
        puVar1 = puVar1 + 1;
      ...
      local_10 = local_28;
      local_c = local_24;
      puVar1 = (undefined4 *)FUN_0081fe60(local_31c,local_1b8,local_f8);
      puVar3 = local_178;
      for (iVar2 = 0x10; iVar2 != 0; iVar2 = iVar2 + -1) {
        *puVar3 = *puVar1;
        puVar1 = puVar1 + 1;
