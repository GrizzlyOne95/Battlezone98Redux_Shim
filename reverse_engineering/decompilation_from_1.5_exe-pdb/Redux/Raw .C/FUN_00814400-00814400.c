...
uint FUN_00814400(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  ...
  uVar3 = FUN_008146f0(*puVar2,puVar2[1],puVar2[2],puVar2[3],puVar2[4]);
  if ((uVar3 & 0xff) == 0) {
