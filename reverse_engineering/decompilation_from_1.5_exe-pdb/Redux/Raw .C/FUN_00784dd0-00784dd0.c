...
undefined4
FUN_00784dd0(double param_1,double param_2,double param_3,float param_4,float param_5,float param_6,
            code *param_7,float *param_8)

{
  ...
  local_10 = FUN_0046eaf0((double)(*param_8 * param_4) + param_1);
  local_c = FUN_0046eaf0(param_3);
  local_14 = FUN_0046eaf0((double)(*param_8 * param_6) + param_3);
  ...
  if (local_20 <= local_1c) {
    ...
    while (-1 < local_14) {
      iVar1 = (*param_7)(local_8,local_c);
      if (iVar1 != 0) {
        FUN_00784d10(local_8,local_c,param_1,param_2,param_3,param_4,param_5,param_6,param_8);
        return 1;
      }
      if (0.0 < local_18) {
        ...
        iVar1 = (*param_7)();
        if (iVar1 != 0) {
          FUN_00784c50(local_8,local_c,param_1,param_2,param_3,param_4,param_5,param_6,param_8);
          return 1;
        }
      }
