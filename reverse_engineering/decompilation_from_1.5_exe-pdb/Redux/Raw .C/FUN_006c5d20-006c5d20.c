...

{
  ...
  if (cVar1 != '\0') {
    ...
    if (&stack0x00000000 == (undefined1 *)0x1c8) {
      ...
      local_c4 = auStack_1b8;
    }
    FUN_007d7970(local_c4,local_100,0,2);
    if (2 < DAT_008eda28) {
      local_e4 = GetPolicy(local_a4);
      local_8._0_1_ = 8;
      pcVar4 = FUN_004bc8c0;
      local_e0 = local_e4;
