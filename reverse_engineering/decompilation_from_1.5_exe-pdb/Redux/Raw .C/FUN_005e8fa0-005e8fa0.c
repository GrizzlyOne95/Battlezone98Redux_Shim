...
undefined1 __thiscall FUN_005e8fa0(int param_1,undefined4 param_2)

{
  ...
  if (DAT_009173b7 == '\0') {
    ...
    if ((cVar2 == '\0') || (cVar2 = FUN_004cd360(param_2,param_1 + 0x70,4,"f_array"), cVar2 == '\0')
       ) {
      bVar1 = false;
    }
    else {
    ...
    if ((bVar1) && (cVar2 = FUN_004cd1b0(param_2,param_1 + 0xa0,4,"i_array",1,uVar3), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
