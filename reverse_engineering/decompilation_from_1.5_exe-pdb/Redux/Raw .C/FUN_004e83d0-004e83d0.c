...
void __thiscall FUN_004e83d0(int param_1,undefined4 param_2)

{
  ...
  if (0 < *(int *)(*(int *)(param_1 + 8) + 0x30)) {
    ...
    local_4c = pfVar2[1];
    local_48 = pfVar2[2];
    local_84 = *(float *)(*(int *)(local_88 + 0xc) + 0xac);
    local_44 = local_50;
    local_40 = local_4c;
    local_3c = local_48;
    iVar3 = FUN_006895d0();
    if (iVar3 < 1) {
      ...
      local_34 = local_84 * 2.0 + local_40;
      local_30 = local_3c;
      local_2c = local_44 + local_84;
      local_28 = local_84 * 2.0 + local_40;
      local_24 = local_3c;
