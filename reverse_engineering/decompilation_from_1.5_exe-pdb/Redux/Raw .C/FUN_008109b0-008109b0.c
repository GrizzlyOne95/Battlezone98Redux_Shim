...
void FUN_008109b0(undefined4 param_1,undefined4 param_2,int *param_3)

{
  int iVar1;
  
  iVar1 = std::_String_const_iterator<class_std::_String_val<struct_std::_Simple_types<char>_>_>::
