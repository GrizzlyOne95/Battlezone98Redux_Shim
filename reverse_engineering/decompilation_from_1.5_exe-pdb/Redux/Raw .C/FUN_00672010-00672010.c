...
/* WARNING: Removing unreachable block (ram,0x006720a7) */
/* WARNING: Removing unreachable block (ram,0x00672178) */
/* WARNING: Removing unreachable block (ram,0x00672249) */
/* WARNING: Removing unreachable block (ram,0x006722ac) */
/* WARNING: Removing unreachable block (ram,0x00672332) */
/* WARNING: Removing unreachable block (ram,0x006723c3) */
/* WARNING: Removing unreachable block (ram,0x00672379) */
/* WARNING: Removing unreachable block (ram,0x00672410) */
/* WARNING: Removing unreachable block (ram,0x00672479) */
/* WARNING: Removing unreachable block (ram,0x006724b3) */
/* WARNING: Removing unreachable block (ram,0x00672522) */
/* WARNING: Removing unreachable block (ram,0x006725b3) */
/* WARNING: Removing unreachable block (ram,0x00672569) */
/* WARNING: Removing unreachable block (ram,0x006725fd) */
/* WARNING: Removing unreachable block (ram,0x0067219f) */
/* WARNING: Removing unreachable block (ram,0x00672200) */
/* WARNING: Removing unreachable block (ram,0x00672244) */
/* WARNING: Removing unreachable block (ram,0x006720ce) */
/* WARNING: Removing unreachable block (ram,0x0067212d) */
/* WARNING: Removing unreachable block (ram,0x0067216f) */
/* WARNING: Removing unreachable block (ram,0x00672601) */

undefined4 FUN_00672010(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_00674b70(param_1,1,*local_18,local_c0,param_4);
    ExceptionList = local_10;
    return param_1;
  }
  ...
  if (local_26 == '\0') {
    ...
    if (local_28 == '\0') {
      ...
      if (local_23 != '\0') {
        ...
        if (local_25 != '\0') {
          ...
          if (*local_e4 != '\0') {
            ...
            local_f4 = get();
            FUN_00674b70(param_1,0,local_f4,local_ec,param_4);
            ExceptionList = local_10;
            return param_1;
          }
          local_fc = FUN_00417780(param_3);
          local_104 = get();
          FUN_00674b70(param_1,1,local_104,local_fc,param_4);
          ExceptionList = local_10;
          return param_1;
        }
      }
      ...
      if (local_1e != '\0') {
        ...
        if (local_29 == '\0') {
          ...
          if (local_1f == '\0') goto LAB_00672b53;
        }
        local_154 = get();
        ...
        if (*local_164 != '\0') {
          ...
          local_174 = get();
          FUN_00674b70(param_1,0,local_174,local_16c,param_4);
          ExceptionList = local_10;
          return param_1;
        }
        local_17c = FUN_00417780(param_3);
        local_184 = get();
        FUN_00674b70(param_1,1,local_184,local_17c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
    }
      ...
      if (local_21 != '\0') {
        ...
        FUN_00674b70(param_1,0,*local_84,local_7c,param_4);
        ExceptionList = local_10;
        return param_1;
      }
      local_21 = 0;
    ...
    if (local_2e != '\0') {
      ...
      local_54 = get();
      FUN_00674b70(param_1,1,local_54,local_4c,param_4);
      ExceptionList = local_10;
      return param_1;
    }
    local_2e = 0;
