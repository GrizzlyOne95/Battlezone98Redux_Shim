...
void FUN_00772310(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if (iVar1 < 0x29) {
    FUN_00772d60(param_1,param_2,param_3,param_4,param_5,param_6,param_7);
  }
  else {
    iVar1 = FUN_00732ef0(&param_1);
    ...
    FUN_00772d60(param_1,param_2,*puVar2,puVar2[1],uVar5,uVar7,uVar3);
    uVar3 = (uint)param_7;
    ...
    FUN_00772d60(*puVar2,puVar2[1],uVar4,uVar6,uVar5,uVar7,uVar3);
    uVar3 = (uint)param_7;
    uVar4 = param_5;
    uVar6 = param_6;
    ...
    FUN_00772d60(*puVar2,puVar2[1],uVar5,uVar7,uVar4,uVar6,uVar3);
    uVar3 = (uint)param_7;
