...
undefined1 __thiscall FUN_0062f710(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar4 = 8;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 0x6c,0x20), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0x12;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x90,0x48), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xdc,0x28,10,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
