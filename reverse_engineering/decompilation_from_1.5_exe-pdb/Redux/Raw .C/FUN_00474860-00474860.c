...
void __fastcall FUN_00474860(int *param_1)

{
  ...
  *(undefined1 *)(param_1 + 0x10) = local_14;
  if ((*(char *)((int)param_1 + 0x41) != '\0') && ((char)param_1[0x10] == '\0')) {
    cVar1 = (**(code **)(*(int *)param_1[8] + 0x68))();
    if (cVar1 == '\0') {
  ...
  case 5:
  case 8:
    cVar1 = (**(code **)(*(int *)param_1[10] + 0x18))();
    if (cVar1 == '\0') {
    ...
    break;
  case 7:
    if ((param_1[10] == 0) || (cVar1 = (**(code **)(*(int *)param_1[10] + 0x18))(), cVar1 != '\0'))
    {
      iVar2 = FUN_00473940();
      if (iVar2 != 0) {
        iVar3 = FUN_00462400();
  ...
  *(char *)((int)param_1 + 0x41) = (char)param_1[0x10];
  return;
}
