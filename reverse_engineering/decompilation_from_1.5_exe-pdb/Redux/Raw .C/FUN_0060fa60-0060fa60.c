...
void __thiscall FUN_0060fa60(int param_1,undefined4 *param_2,int *param_3)

{
  ...
  *(undefined4 *)(local_8 + 0x29c) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 0xcc);
  *(undefined4 *)(local_8 + 0x2a0) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 0xc4);
  *(undefined4 *)(local_8 + 0x2a4) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 200);
  *(undefined4 *)(local_8 + 0x2a8) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 0xd0);
  *(undefined4 *)(local_8 + 0x2b0) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 0xd8);
  *(undefined4 *)(local_8 + 0x2b4) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 0xd4);
  *(undefined4 *)(local_8 + 0x2b8) = *(undefined4 *)(*(int *)(local_8 + 0x218) + 0xdc);
  return;
}
