...
void __fastcall FUN_005c4fb0(int param_1)

{
  ...
  iVar4 = *(int *)(*(int *)(param_1 + 0x28) + 0xc4);
  if ((iVar4 < 0) || ((iVar4 < 1 && (*(int *)(*(int *)(param_1 + 0x28) + 0xc0) == 0)))) {
    if ((local_1c != 0) &&
  ...
  local_18 = FUN_00462630(*(undefined4 *)(*(int *)(param_1 + 0x28) + 0xb0));
  if (local_18 == 0) {
    if ((local_1c == 0) || (*(int *)(*(int *)(param_1 + 0x28) + 0x228) == 0)) {
      for (local_24 = 0x3c; local_24 < 0x41; local_24 = local_24 + 1) {
        iVar4 = FUN_005e0f70(local_24);
        if (iVar4 != 0) {
          uVar6 = (**(code **)(*(int *)(iVar4 + 0x18) + 0xc))();
          uVar6 = (**(code **)(*(int *)(*(int *)(param_1 + 0x28) + 0x18) + 0xc))(uVar6);
          fVar8 = (float10)FUN_00462010(uVar6);
          if ((local_1c == 0) || ((float)fVar8 < 90000.0)) {
            iVar3 = FUN_00466740(*(undefined4 *)(param_1 + 0x28),iVar4);
    ...
    local_28 = FUN_00466740(*(undefined4 *)(param_1 + 0x28),local_18);
  }
  if (local_18 == 0) {
    if (local_1c == 0) {
      *(undefined4 *)(param_1 + 0x20) = 1;
      ...
      if (pvVar5 == (void *)0x0) {
        ...
        local_58 = FUN_006086e0(*(undefined4 *)(param_1 + 0x28));
      }
      local_8 = 0xffffffff;
    ...
    if (*(int *)(*(int *)(param_1 + 0x28) + 0x228) != 0) {
      (**(code **)(**(int **)(param_1 + 0x28) + 100))();
    }
    ...
    if (pvVar5 == (void *)0x0) {
      ...
      local_50 = FUN_004e7a80(*(undefined4 *)(param_1 + 0x28),local_18,local_28,local_48);
    }
    local_8 = 0xffffffff;
