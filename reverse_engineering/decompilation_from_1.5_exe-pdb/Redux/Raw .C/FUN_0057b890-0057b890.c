...
/* WARNING: Removing unreachable block (ram,0x0057ba06) */

void FUN_0057b890(undefined4 param_1,char param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  while (local_48 = (char *)FUN_004242d0(local_28), *local_48 == '\0') {
    local_2c = local_28;
    if (param_2 == '\0') {
      local_58 = FUN_0057bc50(local_28);
      local_84 = FUN_004241e0(param_3);
      local_60 = FUN_00422f60(&local_31);
      local_23 = FUN_00579190(local_84,local_58);
      local_15 = local_23;
    }
    else {
      local_40 = FUN_004241e0(param_3);
      local_50 = FUN_0057bc50(local_28);
      local_78 = FUN_00422f60(&local_33);
      local_1f = FUN_00579190(local_50,local_40);
      local_15 = local_1f == '\0';
  ...
  if (local_15 != '\0') {
    uVar1 = FUN_00424640(local_98);
    local_20 = FUN_004221b0(uVar1);
    if (local_20 != '\0') {
      local_24 = 1;
      local_44 = FUN_00417780(param_3);
      local_4c = FUN_0057ee10(local_94,1,local_2c,local_44,param_4);
  ...
  local_54 = get();
  local_64 = FUN_0057bc50(local_54);
  local_6c = FUN_00422f60(&local_32);
  local_22 = FUN_00579190(local_64,local_5c);
  if (local_22 == '\0') {
    FUN_004178a0(param_4);
    local_1d = 0;
  ...
  local_7c = FUN_0057ee10(local_9c,local_15,local_2c,local_74,param_4);
