...
FUN_0066f050(_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *param_1,
...

{
  ...
  FUN_0066c8e0(p_Var2);
  local_8 = 0;
  uVar3 = FUN_00672e70(param_2,param_3,param_4,local_14,uVar1);
  local_8 = 0xffffffff;
  FUN_0066b640();
  ExceptionList = local_10;
  return uVar3;
