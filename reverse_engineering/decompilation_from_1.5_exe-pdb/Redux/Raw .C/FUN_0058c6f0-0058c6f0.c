...
void FUN_0058c6f0(undefined4 *param_1)

{
  ...
  iVar4 = FUN_0058c280(*param_1,(float)param_1[3] + 0.1);
  if (iVar4 != 0) {
    ...
    while (local_10 < iVar5 - iVar1) {
      piVar7 = (int *)FUN_004200d0(*(undefined1 *)(iVar4 + 0x18 + (iVar6 - iVar2) * 0x10 + local_10)
                                  );
      iVar3 = *piVar7;
