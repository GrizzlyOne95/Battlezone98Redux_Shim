...
undefined4 * __thiscall FUN_006dfb00(undefined4 *param_1,int param_2,int param_3)

{
  ...
  FUN_006dfbf0(param_2);
  *param_1 = boost::exception_detail::
             clone_impl<struct_boost::exception_detail::error_info_injector<class_std::bad_cast>_>::
             vftable;
