...
undefined4 FUN_006dea70(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  uint uVar1;
  undefined4 uVar2;
  undefined4 uVar3;
  _ExceptionHolder *p_Var4;
  _Ref_count_obj<struct_Concurrency::details::_ExceptionHolder> *p_Var5;
  ...
  local_8 = 1;
  p_Var5 = local_1c;
  p_Var4 = std::_Ref_count_obj<struct_Concurrency::details::_ExceptionHolder>::_Getptr(local_1c);
  _Resetp0<>(p_Var4,p_Var5);
  shared_ptr<>(local_2c);
  local_20 = local_20 | 1;
  local_8 = 0xffffffff;
  FUN_006ca8c0();
