...
void __thiscall
FUN_007cd8d0(undefined4 *param_1,char param_2,char *param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  local_8 = 0;
  *param_1 = cUI_ScrollingTextBlock::vftable;
  param_1[0xa56] = 0;
  ...
  if (pvVar3 == (void *)0x0) {
    ...
    local_3c = FUN_007c2480(uVar2,fVar4,fVar5,uVar6,uVar8,uVar9,puVar7,uVar10,uVar11);
  }
  ...
  if (pvVar3 == (void *)0x0) {
    ...
    local_34 = FUN_007c2480(uVar2,param_6,param_7,uVar12,uVar6,uVar8,puVar7,uVar9,uVar10);
  }
  local_8 = CONCAT31(local_8._1_3_,1);
