...
void FUN_0071f780(int param_1,int param_2,undefined4 *param_3,undefined4 param_4)

{
  ...
  FUN_0071fec0(local_80 + 0x38,&local_8c,&param_4);
  local_8._0_1_ = 1;
  uVar3 = FUN_00417780(local_7c);
  FUN_0071f8d0(uVar2,uVar3);
  if (param_1 != 0) {
    FUN_006acde0(0);
    local_8._0_1_ = 2;
    FUN_00725dc0(local_7c,local_7c);
    local_8._0_1_ = 1;
    FUN_006ace20();
  }
