...
void FUN_00686d90(int param_1,int param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  if ((DAT_02b79b34 != 0) && (cVar1 = FUN_0048efc0(), cVar1 != '\0')) {
    ...
    uVar10 = 2;
    uVar11 = DAT_00920ef4;
    uVar3 = FUN_00684bf0(2,DAT_00920ef4);
    FUN_00679d70(uVar3,uVar10,uVar11);
    FUN_0067a110(4,8);
    sVar2 = FUN_00684c10();
    uVar11 = DAT_02b79b2c;
    fVar7 = (float10)FUN_004f90a0(DAT_02b79b2c,(float)param_1 - _DAT_008ed0e0);
    fVar8 = (float10)FUN_004f90a0(uVar11,(float)param_3 - _DAT_008ed0e0);
    fVar9 = (float10)FUN_004f90f0(uVar11,(float)param_2 - _DAT_008ed0e0);
    fVar12 = (float)fVar9;
    fVar9 = (float10)FUN_004f90f0(uVar11,(float)param_4 - _DAT_008ed0e0,fVar12);
