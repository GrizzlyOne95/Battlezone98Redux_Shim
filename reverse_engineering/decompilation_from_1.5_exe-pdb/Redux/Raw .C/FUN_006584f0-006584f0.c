...
undefined1 __thiscall FUN_006584f0(int param_1,undefined4 param_2)

{
  ...
  if (cVar2 == '\0') {
    ...
    cVar2 = FUN_004ce5e0(param_2,param_1 + 0x54,0x2d);
    uVar4 = 8;
    if ((cVar2 == '\0') || (cVar2 = FUN_004ceb10(param_2,param_1 + 0x84,0x20), cVar2 == '\0')) {
      bVar1 = false;
    }
    else {
      bVar1 = true;
    ...
    uVar3 = 0x1f;
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0xa8,0x7c), cVar2 != '\0')) {
      bVar1 = true;
    }
    else {
      bVar1 = false;
    }
    if ((bVar1) && (cVar2 = FUN_004ce910(param_2,param_1 + 0x128,0x1c,7,uVar3,uVar4), cVar2 != '\0')
       ) {
      bVar1 = true;
    }
    else {
    ...
    for (local_10 = 0; local_10 < 7; local_10 = local_10 + 1) {
      *(undefined4 *)(param_1 + 0x128 + local_10 * 4) = 0;
    }
    FUN_00658a90();
