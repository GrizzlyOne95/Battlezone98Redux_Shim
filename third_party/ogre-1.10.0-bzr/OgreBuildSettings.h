...
// Compile-time compatibility settings for the upstream Ogre 1.10.0 reference
// headers used by OpenShim renderer diagnostics.
//
// IMPORTANT:
// Battlezone 98 Redux ships a modified Ogre build whose ABI is not identical to
// pristine upstream 1.10.0. These settings intentionally mirror the known-good
// ExtraUtilities header configuration closely enough to compile reference
// declarations. They do NOT make a rebuilt OgreMain.dll binary-compatible with
// the game's shipped OgreMain.dll.
