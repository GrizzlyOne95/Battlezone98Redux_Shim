...
//
// Reconstructed from analysis of [third-party patch DLL] and the GOG v2.2.301 executable.
...
// Ghidra-confirmed [third-party patch DLL] pipeline:
...
// Ghidra-confirmed [third-party patch DLL] trampoline:
//   MOV EAX,[0x0094555C]
//   MOV ECX,[EAX]
...
// Ghidra-confirmed [third-party patch DLL] helper FUN_1000CCA0 replays the native list-step
...
// -----------------------------------------------------------------------
// Probe: refresh/map-sorting path candidate (historical [third-party patch DLL] patch site)
// Site: 0x007680D6
// Original bytes:
...
// Stub mirrors [third-party patch DLL]: call 0x481EA0, then original 0x481AF0, then jump
