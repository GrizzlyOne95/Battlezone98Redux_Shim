...
// and [third-party patch]_hopfix_decompiled.txt.
//
...
namespace BZROpenShim
{
    ...
    // Mirrors [third-party patch DLL] FUN_1000CAF0 semantics (clean-room).
    ...
    // Mirrors [third-party patch DLL] FUN_1000CB40 semantics (clean-room).
    ...
    // Mirrors [third-party patch DLL] FUN_1000CCA0 semantics (clean-room).
    ...
    // Selects HopFix2 this-pointer using the [third-party patch DLL]-style global map object.
