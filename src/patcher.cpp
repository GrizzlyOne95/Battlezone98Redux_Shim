...
namespace BZROpenShim
{
    ...
    static void ResolvePointers(uint32_t hopFix1Addr, uint32_t hopFix2Addr, uint32_t hopFix3Addr, uint32_t probeMapSortingAddr, uint32_t probeMapFilter1Addr)
    {
        ...
        // Hop-Fix 2 - [third-party patch DLL] jumps back to patch site + 0x13 after its
    ...
    void RunPatcher(uint32_t shimVersion)
    {
        ...
        LogShimA(LogLevel::Info, "patcher", "Open source replacement for [third-party patch DLL] / [third-party proxy DLL]");
