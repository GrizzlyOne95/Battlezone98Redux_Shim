...
//   1. Executes the replacement logic derived from [third-party patch DLL] decompilation
//   2. Jumps back to BZR.exe via the corresponding g_RetAddr_* pointer
//
// The assembly was reconstructed from [third-party patch]_hopfix_decompiled.txt and
